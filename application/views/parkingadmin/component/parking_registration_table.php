...
<table id="<?php echo (count($tpl['arr'])) ? "paidparking_registration_table" : ""; ?>" class="gzblog-table table-striped table-hover" cellpadding="0" cellspacing="0" >
    <thead>
        ...
        <th><?php echo __('Membership Category'); ?></th>
            ...
            <th><?php echo __('If Senior 70+'); ?></th>
            ...
            for ($i = 0; $i < $count; $i++) {
              ...
              <tr class="<?php echo $i % 2 === 0 ? 'odd' : 'even'; ?>">
                   ...
                   <td><?php echo $tpl['arr'][$i]['state']; ?></td>
                    <td><?php echo $tpl['arr'][$i]['seniorseventyplus']; ?></td>
                  ...
                  <?php } ?>
                    ...
                    <td><a class="btn btn-success btn-sm" href="<?php echo INSTALL_URL; ?>parkingadmin/edit/<?php echo $tpl['arr'][$i]['id']; ?>" rev="<?php echo $tpl['arr'][$i]['id']; ?>"><span class="glyphicon glyphicon-eye-open"></span></a></td>
                   <?php }?>
