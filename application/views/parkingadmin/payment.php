...
<?php
if (!empty($_POST['paidparking_payment'])) {
    ?>
                ...
                if ($_POST['PaymentOption'] == 'stripe') {
                    ...
                    ?>
                     <table border="4" width='585px'>
                                ...
                                <tr><td>Member Name</td> <td><?php echo $_POST['First_name'].' ' .$_POST['Last_name'];?></td></td></tr>
                                <tr><td>Puja Type</td> <td><?php echo $_POST['puja_type']; ?></td></tr>
                                <tr><td>Parking Spot</td> <td><?php echo $_POST['parkingfield']; ?></td></tr>
                                <tr><td>Amount</td> <td><span style="color:red;">$</span><?php echo $_POST['amount']; ?></td></tr>
...
$paymentstatus = $tpl['paidregistrationarr']['status'];


?>
<form id="paidparking-frm-id" class="frm-class booking-frm-class" action="<?php echo INSTALL_URL; ?>parkingadmin/payment" method="post" name="payment">
<td colspan='2'>
     <img src="<?php echo INSTALL_URL; ?>thankyouscreen.jpg" class="profile" />
     <h2  style="text-align:center;font-family:fangsong; font-size:30px;margin-top:-10px;">HDBS Paid Parking Registration Payment</h2>
    </td> 
                            ...
                            <div class="box box-solid box-primary">
                                ...
                                <div class="form-group">
                                        ...
                                        <input id="registrationfor" class="form-control input-sm" type="text"
                                            ...
                                            value="<?php echo $tpl['paidregistrationarr']['puja_type']; ?>" title="Registration Type"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="memberid" class="form-control input-sm" type="text" name="Member_id"
                                            size="25" value="<?php echo $tpl['paidregistrationarr']['Member_id']; ?>" title="Member Id"
                                    ...
                                    <input id="category" class="form-control input-sm" type="text" name="membercategory"
                                            size="25" value="<?php echo $tpl['paidregistrationarr']['membercategory']; ?>" title="Category"
                                            placeholder="" required readonly> 
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="parkingspot" class="form-control input-sm" type="text" name="parkingfield"
                                            size="25" value="<?php echo $tpl['paidregistrationarr']['parkingfield']; ?>" title="Parking Spot"
                                ...
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input data-rule-required="true" id="total_value4"
                                                class="form-control input-sm" type="text" name="amount" size="25"
                                                value="<?php echo $tpl['paidregistrationarr']['amount']; ?>"
                                    ...
                                    <div class="form-group">
                                          <label class="control-label" for="status">
                                            ...
                                            <input id="status" class="form-control input-sm" type="text"
                                                name="status" size="25"
                                                value="<?php echo $tpl['paidregistrationarr']['status']; ?>"
...
<!-- end -->
                            ...
                            <div class="box box-solid box-primary">
                                ...
                                <div class="box-body">
                                    <div class="form-group" id="paymentdropdown">
                                        ...
                                        <select data-rule-required="true" name="PaymentOption" id="PaymentOption" class="form-control input-sm" required>
                ...
                <tr id="stripe_details" class="tr" style="display: none;">
                   ...
                   <td id="error_codeimg"></td>
                                ...
                                <input type="hidden" name="paidparking_payment" value="1" /> 
                                    <input type="hidden" name="id" value="<?php echo $tpl['paidregistrationarr']['id']; ?>" />
                            ...
                            <div class="box box-solid box-primary">
                                ...
                                <div class="form-group">
                                        <label class="control-label" for="paymentfor">
                                           ...
                                           <!-- <input style="visibility: visible;margin: 34px 0px 0px 4px;" class="checkbox" type="checkbox" id="senior" <?php //echo ($tpl['paidregistrationarr']['senior'] == '1') ? "checked='checked'" : ""; ?> name="senior" value="1" onchange="calculateseniordiscount(this)">
                                              <label for="senior" style="color:red;">if Senior</label>-->

                                            <input style="visibility: visible;margin: 34px 0px 0px 4px;" class="checkbox" type="checkbox" id="veggie" <?php echo ($tpl['paidregistrationarr']['seniorseventyplus'] == 'yes') ? "checked='checked'" : ""; ?> name="seniorseventyplus" value="yes">
                                             <label for="veggie" style="color:red;">if Senior 70+</label>&nbsp;&nbsp;&nbsp;&nbsp;

                                             
                                        </label>
                                        <input id="membername" class="form-control input-sm" type="text" name="First_name"
                                            size="25" value="<?php echo $tpl['paidregistrationarr']['First_name']; ?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="membername" class="form-control input-sm" type="text" name="Last_name"
                                            size="25" value="<?php echo$tpl['paidregistrationarr']['Last_name']; ?>"
                                            title="<?php echo __('Last Name'); ?>" placeholder="" readonly>
                                    </div>
                                    <?php if ($tpl['paidregistrationarr']['Sp_fname'] !="")  { ?>
                                <div class="form-group">
                                        <label class="control-label" for="paymentfor">
                                        ...
                                        <input id="spousename" class="form-control input-sm" type="text" name="spousename"
                                            size="25" value="<?php echo $tpl['paidregistrationarr']['Sp_fname']. ' ' . $tpl['paidregistrationarr']['Sp_lname']; ?>"
                            ...
                            <div class="box box-solid box-primary">
                                ...
                                <div class="form-group">
                                        ...
                                        <input id="street" class="form-control input-sm" type="text" name="street"
                                            size="25" value="<?php echo $tpl['paidregistrationarr']['street']; ?>" title="Address"
                                            placeholder="" required readonly>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input id="streetname" class="form-control input-sm" type="text" name="streetname"
                                            size="25" value="<?php echo $tpl['paidregistrationarr']['streetname']; ?>" title="Address"
                                            placeholder="" required readonly>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input id="unit" class="form-control input-sm" type="text" name="unit"
                                            size="25" value="<?php echo $tpl['paidregistrationarr']['unit']; ?>" title="Address"
                                            placeholder="" required readonly>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input id="city" class="form-control input-sm" type="text" name="city" size="25"
                                            value="<?php echo $tpl['paidregistrationarr']['city']; ?>" title="<?php echo __('City'); ?>"
                                            placeholder="" required readonly>
                                    </div>
                                    <div class="form-group">
                                      ...
                                      <input id="state" class="form-control input-sm" type="text" name="state" size="25" value="<?php echo $tpl['paidregistrationarr']['state']; ?>" title="<?php echo __('State'); ?>" readonly>  
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="zip" class="form-control input-sm" type="text" name="zip" size="25"
                                            value="<?php echo $tpl['paidregistrationarr']['zip']; ?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="phone" class="form-control input-sm" type="text" name="phone"
                                            size="25" value="<?php echo $tpl['paidregistrationarr']['phone']; ?>" title="phone"
                                            maxlength="10" placeholder="### ###-####" required readonly>
                                    </div>
                                    <?php if ($tpl['paidregistrationarr']['alternatenumber'] !="")  { ?>
                                    <div class="form-group">
                                        <label class="control-label" for="phone">
                                            <?php echo __('Alternate Conatct'); ?>:
                                        </label>
                                        <input id="phone" class="form-control input-sm" type="text" name="tele1"
                                            size="25" value="<?php echo $tpl['paidregistrationarr']['alternatenumber']; ?>" title="Alternate Conatct"
                                            maxlength="10" placeholder="### ###-####" required readonly>
                                    </div>
                                    <?php
                                      } ?>
                                    <div class="form-group">
                                        ...
                                        <input id="phone" class="form-control input-sm" type="text" name="email"
                                            size="25" value="<?php echo $tpl['paidregistrationarr']['email']; ?>" title="email"
                                            placeholder="name@company.com" pattern="[^@\s]+@[^@\s]+\.[^@\s]+" required readonly>
                                    </div>
                                    <?php if ($tpl['paidregistrationarr']['alternateemail'] !="")  { ?>
                                    <div class="form-group">
                                        <label class="control-label" for="email">
                                            <?php echo __('Alternate Email'); ?>:
                                        </label>
                                        <input id="phone" class="form-control input-sm" type="text" name="alternateemail"
                                            size="25" value="<?php echo $tpl['paidregistrationarr']['alternateemail']; ?>" title="Alternate Email"
                                            placeholder="name@company.com" pattern="[^@\s]+@[^@\s]+\.[^@\s]+" required readonly>
                                    </div>
                                    <?php
                                      } ?>
