...
.checkbox label#admindocumentcheck-error {margin: 0px 0px 0px 0px!important;}
select.ui-datepicker-year { width: 90%!important; padding: 7px 0px 7px 0px; background-color: #000; color: #fff; border-radius: 10px; }
.ui-datepicker .ui-datepicker-title select { font-size: 16px; font-weight: 800; width: 90%!important; letter-spacing: 1px; }
...
select.choice { width: 100%; padding: 14px; font-size: 24px; text-transform: capitalize; color: #fff; background-color: #ef260f; border-radius: 15px; }
...
.checkbox label { font-size: 14px; font-weight: 600; display: block; color: #ef260f; margin: 34px 0px 0px 36px !important; }
.checkbox2 label { font-size: 14px; font-weight: 600; display: block; color: #ef260f; margin: 16px 0px 16px 36px !important; }
.checkbox3 label { font-size: 14px; font-weight: 600; display: block; color: #ef260f; margin: 16px 0px 16px 36px !important; }
...
#gocartbutton{ padding: 10px; font-size: 22px; border-radius: 10px; width: 100%; background-color: #000; color: #fff; margin-top: 30px; font-weight: 600; }
#datasubmit{ padding: 10px; font-size: 22px; border-radius: 10px; width: 100%; background-color: #000; color: #fff; margin-top: 30px; font-weight: 600; }
/* payment button css  */
...
.col-md-6.phone { padding-top: 20px;}
input#memphonefam { width: 405px;}
input#memphone2fam { width: 405px;}
}
</style>
<link rel="shortcut icon" href="https://durgabari.org/HDBS_Puja_Payments/favicon.ico" type="image/x-icon"/>
            ...
            <div class="row clearfix">
                ...
                <div class="breadcrumb-column col-lg-6 col-md-12 col-sm-12">
                    ...
                    <ul class="bread-crumb clearfix">
                        <li><a style="text-decoration:none;color:#fff;" href="https://durgabari.org/HDBS_Puja_Payments/Associatepayments/Associatepayments">Home</a></li>
...
if($mainadminrole == "true"){
    ...
    <div class="row">
        <div class="col-lg-8 col-md-12 col-sm-12">
            <div style="border-left: 3px solid #ef260f;border-right: 3px solid #ef260f;border-bottom: 3px solid #ef260f;padding:10px;" id="showRegistration" class="myChoice">
                <div class="clear"></div>
                ...
                <form id="pujapasses-frm-id" method="POST" action="" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <select class="choice" id="pul" name="puja_type" required>
                                ...
                                <option value="Durga Puja Friday Evening">Durga Puja Friday Evening</option>
                                <option value="Durga Puja Saturday Full Day">Durga Puja Saturday Full Day</option>
                                <option value="Durga Puja Saturday Evening">Durga Puja Saturday Evening</option>
                                <option value="Durga Puja Sunday Full Day">Durga Puja Sunday Full Day</option>
                                <!--<option value="Durga Puja Sunday Evening">Durga Puja Sunday Evening</option>
                                <option value="Durga Puja Monday Evening">Durga Puja Monday Evening</option>-->
                            </select>
                    ...
                    <option value="student">Student</option> -->
                            ...
                            <div class="text_placeholders">Returning or New User <span style="color:#ff0000;">*</span></div>
                        </div>
                    ...
                    <div class="row" style="display:none;" id="membersearchdiv">
                        <div class="col-md-12">
                            <input class="MIDtext2" type="text" name="term" id="term" placeholder="Search your records *" onclick="document.getElementById('futureytd').value = ''" tabindex="2" required>
                            <input class="MIDtext2" type="text" style="display:none" name="termMember" id="termMember" placeholder="Search your records">
                            <div class="text_placeholders">Search by : First Name, Last Name, Zip, MID <span style="color:#ff0000;">*</span></div>
                            <div id="div1"></div>
                        </div>
                    </div>
                    <br>
                    ...
                    <div class="row" id="memberinformationdiv" style="display:none;">
                        ...
                        <div class="col-md-4">
                            <input class="MIDtext2readonly" style="width:100%;" type="text" name="Member_type" id="memtypefam" placeholder="Membership Status" readonly/>
                    ...
                    <div class="row" id="parent_register" style="display:none;">
                        <div class="col-md-12 checkbox2">
                            <input style="visibility: visible;margin: 16px 0px 0px 4px;" class="checkbox"
                                type="checkbox" name="parent_register" id="parentregistercheck" value="1" onclick="myFunction()">
                    ...
                    <div class="row" id="parent_register_details" style="display:none;">
                        <div class="col-md-6">
                            <input class="MIDtext2" type="text" name="parent1_fname" id="parent_register_fname" placeholder="Parent First Name *">
                            <div class="text_placeholders">Parent First Name <span style="color:#ff0000;">*</span></div>
                        </div>
                        <div class="col-md-6">
                            <input class="MIDtext2" type="text" name="parent1_lname" id="parent_register_lname" placeholder="Parent Last Name *">
                            ...
                            <div id="dvOptionalchild1" style="display:none;">
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="text_placeholders">Child 1 First Name <span style="color:#ff0000;">*</span></div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="text_placeholders">Child 1 Last Name <span style="color:#ff0000;">*</span></div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="text_placeholders">Child 1 Birth Year <span style="color:#ff0000;">*</span></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="dvOptionalchild2" style="display:none;">
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="text_placeholders">Child 2 First Name <span style="color:#ff0000;">*</span></div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="text_placeholders">Child 2 Last Name <span style="color:#ff0000;">*</span></div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="text_placeholders">Child 2 Birth Year <span style="color:#ff0000;">*</span></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="dvOptionalchild3" style="display:none;">
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="text_placeholders">Child 3 First Name <span style="color:#ff0000;">*</span></div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="text_placeholders">Child 3 Last Name <span style="color:#ff0000;">*</span></div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="text_placeholders">Child 3 Birth Year <span style="color:#ff0000;">*</span></div>
                                    </div>
                                </div>
                            </div>
...
<input style="visibility: visible;margin: 34px 0px 0px 4px;" class="checkbox"type="checkbox" value="1" id="myCheck2" onclick="myFunction()">
...
<div id="text2" style="display:none">
    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <input class="MIDtext2" required style="width:100%;" type="text" name="street" id="memstreetfam"
                                    placeholder="Street # *" />
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <input class="MIDtext2" required style="width:100%;" type="text" name="city" id="memcityfam"
                                    placeholder="City *" />
                                <div class="text_placeholders">City <span style="color:#ff0000;">*</span></div>
                            </div>

                            <div class="col-md-4">
                                <input class="MIDtext2" required style="width:100%;" type="text" name="state" id="memstatefam"
                                    placeholder="State *" />
                                <div class="text_placeholders">State <span style="color:#ff0000;">*</span></div>
                            </div>

                            <div class="col-md-4">
                                <input class="MIDtext2"  required style="width:100%;" type="text" name="zip" id="mamzipcodefam"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 phone">
                                <input class="MIDtext2" required type="text" name="alternatenumber"
                                    id="memphone2fam" maxlength="10" placeholder="### ### ####" />
                                <div class="text_placeholders">Mobile Number *</div>
                            </div>
                            <div class="col-md-6">
                                <input class="MIDtext2" required style="width:100%;" type="text" name="email" id="mememailfam"
                                    placeholder="name@company.com" pattern="[^@\s]+@[^@\s]+\.[^@\s]+" />
                        ...
                        <div class="row" id="schoolnamediv" style="display:none;">
                            <div class="col-md-12">
                                ...
                                <div class="text_placeholders">Name of college or University <span style="color:#ff0000;">*</span></div>
                            </div>
                        </div>
...
<input type="hidden" name="stripeToken" id="stripeToken" value="" />
                        ...
                        <div class="row" id="documentuploaddiv" style="display:none;">
                            <div class="col-md-12">
                                ...
                                <div class="text_placeholders">Upload Document for Out of Towner Address or Student Age Verification(jpg,png,jpeg,pdf format) <span style="color:#ff0000;">*</span>
                                </div>
                            </div>
                        </div>
                         ...
                         <div class="row">
                            ...
                            <div class="col-md-6" id="addcartbuttondiv">
                                <button type="submit" id="gocartbutton" class="btn btn-primary" name="get_cart"
                                    onclick="return confirm('Are you sure you want to Submit this Request? If you want to update anything then please press Cancel button to Update and Review the information OR press Ok to Submit this Request for your Puja Pass.')">Submit Request</button>
                            </div>
                            <?php } ?>
...
<?php if ($this->controller->isAdmin() || $this->controller->isEditor()) { ?>
                    <a style="font-size: 24px; text-decoration: none;color:#000;" href="https://durgabari.org/HDBS_Puja_Payments/PujaPassesadmin/index">Go Back to Dashboard</a>
                    <br><br>
                     <?php } ?>
                ...
                <div class="widget-content">
                    <div class="text"><strong>Step 1 : </strong>Express your interest to purchase Day/Evening Passes</div>
                    ...
                    <div class="text"><strong>1. </strong>Passes will be issued in limited quantities and will depend on overall registration level. Out of Towners and 22+ children of Puja registrants will have higher priority and can submit requests for all the options offered. Greater Houston residents are open to apply for Sunday Passes only. </div>
                    <div class="text"><strong>2. </strong>Day Pass includes lunch and dinner. Evening Pass dinner only. Both Day and Evening Passes include access to cultural programs </div>
                    <div class="text"><strong>3. </strong>For family registration, children allowed free subject to Year of Birth in 2001 or later.</div>
                    <div class="text"><strong>4. </strong>Parents cannot be included in Passes</div>
                    <div class="text"><strong>5. </strong>Student rate applicable to FULL TIME students only. Part time or Executive MBA students are not eligible.</div>
                    <div class="text"><strong>6. </strong>Student with family only if the spouse is not working</div>
                    <div class="text"><strong>7. </strong>OOT and Students need to submit relevant documents (Address proof for OOT/Student ID for Students) online. Registration team will validate and send a confirmation with an individualized payment link. You may blank off date of birth or any other personal information</div>
                    <div class="text"><strong>8. </strong>Student IDs must have an expiry date or an issue date within the last one year. If none available, submit a recent tuition fee payment receipt or a score card.</div>
                    <div class="text"><strong>9. </strong>No onsite parking is available. Registrants can use the free shuttle bus service or Uber/Lyft</div>
                </div>
            </div>
            ...
            <div class="sidebar-widget help-widget">
                ...
                <p><span><i class="fa fa-phone" aria-hidden="true"></i></span><a style="color:#000;text-decoration:none;" href="tel:+18327234829"> <strong style="font-size:26px;">+1 832-723-4829</strong> <br><span style="font-size:20px;color:#000;">Debashish Sarkar</span></a></p>
