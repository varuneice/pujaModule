            ...
            <fieldset>
                ...
                <table class="table">
                    ...
                    <tr class="tr">
                        ...
                        <td colspan="2" class="td">
                            ...
                            <input
                                ...
                                type="radio" id="family_membership" name="membership_type" value="family_membership">
                            Family Membership
                        </td>
                    </tr>
                    </tr>
                    <tr class="tr">
                        ...
                        <td class="td">
                            <input id="Spouse" class="form-control input-sm" type="text" name="Sp_FName" size="25"
                    ...
                    <tr class="tr">
                        ...
                        <td  class="td">
                            <input id="Address" class="form-control input-sm" type="text" name="Address1" size="25"
                                value="<?php echo ($tpl['arr'] ?? [])['Address1'] ?? ''; ?>" title="Address" placeholder="Address">
                        </td>
                    ...
                    <tr class="tr">
                        ...
                        <td class="td">
                            <input id="state" class="form-control input-sm" type="text" name="State" size="25"
                                value="<?php echo ($tpl['arr'] ?? [])['State'] ?? ''; ?>" title="State" placeholder="State">
                        </td> .
                        <td class="td">
                    ...
                    <tr class="tr">
                        ...
                        <td class="td">
                            <input id="phone_No" class="form-control input-sm" type="number" name=" <input id=" Tele1"
                                class="form-control input-sm" type="tel" name="Tele1" size="25"
                                value="<?php echo ($tpl['arr'] ?? [])['Tele1'] ?? ''; ?>"  pattern="[0-9]{3}[0-9]{3}[0-9]{4}" title="Mobile No" placeholder="Mobile No">
                        </td>
                        <td class="td">
                    ...
                    <tr class="tr">
                        ...
                        <td class="td">
                            <input id="email" class="form-control input-sm" type="text" name="email" size="25"
                                value="<?php echo ($tpl['arr'] ?? [])['email'] ?? ''; ?>" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" title="Email" placeholder="Email">
                        </td>
                        <td class="td">
                            Email 2
                        </td>
                ...
                <table id="children" style="display: none;" class="table">
                    ...
                    <tr class="tr">
                        ...
                        <td class="td">Year of Birth<input max="<?php echo date('Y-m-d'); ?>" id="year_birth"
                ...
                <table class="table">
                        ...
                        <td class="td" colspan="2" id="img-file-id">
                            ...
                            <fieldset>
                                <div class="view view-tenth">
                                    <img
                                        src="<?php echo INSTALL_URL . UPLOAD_PATH . 'avatar/thumb/' . ($tpl['arr'] ?? [])['avatar'] ?? ''; ?>" style="width: 286px;height: 183px;" />
                                    <div class="mask">
                    ...
                    <tr class="tr">
                        ...
                        <td class="td" colspan="2">
                            <input required="true" id="password" class="form-control input-sm" type="text"
                                name="password" size="25" value="" title="password" placeholder="password">
                        </td>
                    </tr>
