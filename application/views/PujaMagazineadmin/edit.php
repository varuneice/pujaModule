...
if ($paymethod == 'stripe') {
    ...
    $paymentdata = 'Online Deposit';
}

// $modeofcollection1 = $tpl['pujadataarr']['category'];
...
?>
<form id="edit_pujamagazinedata" class="frm-class booking-frm-class" action="<?php echo INSTALL_URL; ?>PujaMagazineadmin/edit"
                            ...
                            <div class="box box-solid box-primary">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="memberid" class="form-control input-sm" type="text" name="membercategory"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="memberid" class="form-control input-sm" type="text" name="Member_type"
                                ...
                                <div class="box-body">
                                     ...
                                     <input id="category" class="form-control input-sm" type="text" name="mode_of_collection"
                                            size="25" value="<?php echo $tpl['pujadataarr']['mode_of_collection']; ?>" title="Mode of Collection"
                                            placeholder="" required readonly>
                                    </div>
...
<!-- payment div start -->
                        ...
                        <section class="col-lg-5 connectedSortable ui-sortable">
                            <div class="box box-solid box-primary">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label" for="phone">
                                            <?php echo __('Alternate Contact'); ?>:
                                        </label>
                                         <input id="phone" class="form-control input-sm" type="text" name="alternatenumber"
                                            size="25" value="<?php echo $tpl['pujadataarr']['alternatenumber']; ?>" title="Alternate Contact"
                                            maxlength="10" placeholder="### ###-####" required readonly>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="phone" class="form-control input-sm" type="text" name="email2"
                                            size="25" value="<?php echo $tpl['pujadataarr']['email2']; ?>" title="Alternate Email"
                                            placeholder="name@company.com" pattern="[^@\s]+@[^@\s]+\.[^@\s]+" required readonly>
                                    </div>
                                </div>
                        </section>
                ...
                <fieldset class="form-actions">
                    <input type="hidden" name="edit_pujamagazinedata" value="1" />
