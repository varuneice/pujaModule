...
$registermember = $tpl['magazinearr']['member_status']; 
?>
<form id="edit_registration" class="frm-class booking-frm-class" action="<?php echo INSTALL_URL; ?>PujaMagazineadmin/payment" method="post" name="payment">
<td colspan='2'>
                    ...
                    <fieldset>
                        ...
                        <div class="box box-solid box-primary">
                                ...
                                <div class="form-group">
                                        ...
                                        <input id="category" class="form-control input-sm" type="text" name="mode_of_collection"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="total_value4" class="form-control input-sm" type="number"
