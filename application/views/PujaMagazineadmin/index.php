...
<section class="content">
    ...
    <div class="nav-tabs-custom">
        <ul class="nav nav-tabs" id="myTabMagazine">
            <li class="active">
                <a data-toggle="tab" href="#magazine_tab_1"><?php echo __('Puja Magazine'); ?></a>
            </li>
            <li class="">
                <a data-toggle="tab" href="#magazine_tab_2"><?php echo __('All Magazine Price'); ?></a>
            </li>
        </ul>
        <div class="tab-content">
            <div id="magazine_tab_1" class="tab-pane active">
                <div class="box">
            ...
            <div id="magazine_tab_2" class="tab-pane">
                <div class="box">
                    <div class="box-body table-responsive">
                        <div id="magazine_tab_2_wrapper" class="dataTables_wrapper form-inline" role="grid">
                            <form name="table-frm" id="table-frm-id" method="post" action="<?php echo INSTALL_URL; ?>?controller=PujaMagazineadmin&action=deleteSelected">
                                <?php
...
$(document).ready(function(){
    var tabKey = 'activeTab_magazineadmin';
    $('#myTabMagazine a[data-toggle="tab"]').on('click', function(e) {
        e.preventDefault();
        var target = $(this).attr('href');
        $('#myTabMagazine li').removeClass('active');
    ...
    if (activeTab && $('#myTabMagazine a[href="' + activeTab + '"]').length) {
        $('#myTabMagazine a[href="' + activeTab + '"]').trigger('click');
    }
});
</script>