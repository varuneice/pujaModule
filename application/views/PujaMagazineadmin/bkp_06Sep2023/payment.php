...
<?php
if (!empty($_POST['magazine_payment'])) {
    ?>
...
<section class="content-header" style="display:none;">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo INSTALL_URL; ?>PujaMagazineadmin/index"><?php echo __('Puja Magazine'); ?></a></li>
        <li class="active"><?php echo __('Puja Magazine'); ?></li>
    </ol>
</section>
<?php
require_once VIEWS_PATH . 'Layouts/admin/error_notice.php';
$state = $tpl['magazinearr']['state']; 
$paymentstatus = $tpl['magazinearr']['status'];
$registermember = $tpl['mgazinearr']['member_status']; 

?>
<form id="edit_magazine" class="frm-class booking-frm-class" action="<?php echo INSTALL_URL; ?>PujaMagazineadmin/payment" method="post" name="payment">
<td colspan='2'>
     <img src="https://durgabari.org/HDBS_Payment/thankyouscreen.jpg" class="profile" />
     <h2  style="text-align:center;font-family:fangsong; font-size:30px;margin-top:-10px;">HDBS Puja Magazine Payment</h2>
    </td> 
                        ...
                        <section class="col-lg-7 connectedSortable">
                            <div class="box box-solid box-primary">
                                <div class="box-header">
                                    <h3 class="box-title"><?php echo __('Member Information'); ?></h3>
                                ...
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <input id="membername" class="form-control input-sm" type="text" name="membername"
                                            size="25" value="<?php echo $tpl['magazinearr']['First_name']. ' ' . $tpl['magazinearr']['Last_name']; ?>"
                                ...
                                <div class="form-group">
                                        ...
                                        <input id="registrationfor" class="form-control input-sm" type="text"
                                            ...
                                            value="<?php echo $tpl['magazinearr']['member_status']; ?>" title="Member Status"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="memberid" class="form-control input-sm" type="text" name="Member_id"
                                            size="25" value="<?php echo $tpl['magazinearr']['Member_id']; ?>" title="Member Id"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="registrationfor" class="form-control input-sm" type="text" name="registrationtype"
                                            size="25" value="<?php echo $tpl['magazinearr']['membercategory']; ?>" title=""
                                            placeholder="" required  readonly>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input id="optional" class="form-control input-sm" type="text" name=""
                                            size="25" value="<?php echo $tpl['magazinearr']['Member_type']; ?>" title=""
                        ...
                        <div class="box box-solid box-primary">
                                ...
                                <div class="form-group">
                                        <label class="control-label" for="magazine">
                                            <?php echo __('Mode of Collection'); ?>:
                                        </label>
                                        <input id="magazine" class="form-control input-sm" type="number" name="magazine"
                                            size="25" value="<?php echo $tpl['magazinearr']['mode_of_collection']; ?>" title="Mode of Collection"
                                            placeholder="Mode of Collection" required readonly>
                                    </div>
                                       <div class="form-group">
                                        <label class="control-label" for="magazine">
                                        ...
                                        <input id="magazine" class="form-control input-sm" type="number" name="magazine"
                                            size="25" value="<?php echo $tpl['magazinearr']['magazine']; ?>" title="No. of Magazine(s)"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="totalamount" class="form-control input-sm" type="number"
                                                ...
                                                value="<?php echo $tpl['magazinearr']['totalamount']; ?>"
                                          ...
                                          <label class="control-label" for="status">
                                            ...
                                            <!-- <select data-rule-required="true" name="status" id="status"
                                                ...
                                                foreach ($status_arr as $k => $v) {
                                                    ?>
                                                    <option <?php echo ($tpl['magazinearr']['status'] == $k) ? "selected='selected'" : ""; ?> value="<?php echo $k; ?>"><?php echo $v; ?></option>
                                                    <?php
                                                }
                                                ?>
                                            </select> -->
                                            <input id="status" class="form-control input-sm" type="text"
                                                name="status" size="25"
                                                value="<?php echo $tpl['magazinearr']['status']; ?>"
...
<!-- end -->
                ...
                <td id="error_codeimg"></td>
                                ...
                                <input type="hidden" name="magzine_payment" value="1" /> 
                                    <input type="hidden" name="id" value="<?php echo $tpl['magazinearr']['id']; ?>" />
                            ...
                            <div class="box box-solid box-primary">
                                ...
                                <div class="form-group">
                                        ...
                                        <input id="street" class="form-control input-sm" type="text" name="street"
                                            size="25" value="<?php echo $tpl['magazinearr']['street']; ?>" title="Address"
                                            placeholder="" required readonly>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input id="streetname" class="form-control input-sm" type="text" name="address"
                                            size="25" value="<?php echo $tpl['magazinearr']['streetname']; ?>" title="Address"
                                            placeholder="" required readonly>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input id="unit" class="form-control input-sm" type="text" name="addres2"
                                            size="25" value="<?php echo $tpl['magazinearr']['unit']; ?>" title="Address"
                                            placeholder="" required readonly>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input id="city" class="form-control input-sm" type="text" name="city" size="25"
                                            value="<?php echo $tpl['magazinearr']['city']; ?>" title="<?php echo __('City'); ?>"
                                            placeholder="" required readonly>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input id="state" class="form-control input-sm" type="text" name="state" size="25" value="<?php echo $tpl['magazinearr']['state']; ?>" title="<?php echo __('State'); ?>" placeholder="" readonly>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="zip" class="form-control input-sm" type="text" name="zip" size="25"
                                            value="<?php echo $tpl['magazinearr']['zip']; ?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="phone" class="form-control input-sm" type="text" name="phone"
                                            size="25" value="<?php echo $tpl['magazinearr']['phone']; ?>" title="phone"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="phone" class="form-control input-sm" type="text" name="tele1"
                                            size="25" value="<?php echo $tpl['magazinearr']['alternatenumber']; ?>" title="Alternate Conatct"
                                            maxlength="10" placeholder="### ###-####" required readonly>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input id="phone" class="form-control input-sm" type="text" name="email"
                                            size="25" value="<?php echo $tpl['magazinearr']['email']; ?>" title="email"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="phone" class="form-control input-sm" type="text" name="email2"
                                            size="25" value="<?php echo $tpl['magazinearr']['alternateemail']; ?>" title="Alternate Email"
                                            placeholder="name@company.com" pattern="[^@\s]+@[^@\s]+\.[^@\s]+" required readonly>
                                    </div>
                                </div>
                        </section>
