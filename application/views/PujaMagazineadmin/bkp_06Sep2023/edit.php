                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="streetname" class="form-control input-sm" type="text" name="address"
                                            size="25" value="<?php echo $tpl['pujadataarr']['address']; ?>" title="Address"
                                            placeholder="" required readonly>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input id="unit" class="form-control input-sm" type="text" name="addres2"
                                            size="25" value="<?php echo $tpl['pujadataarr']['addres2']; ?>" title="Address"
                                            placeholder="" required readonly>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="phone" class="form-control input-sm" type="text" name="tele1"
                                            size="25" value="<?php echo $tpl['pujadataarr']['tele1']; ?>" title="Alternate Contact"
                                            maxlength="10" placeholder="### ###-####" required readonly>
                                    </div>
                                    <div class="form-group">
