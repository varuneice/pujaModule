        ...
        if ($count > 0) {
            ...
            //    $statusactive = $tpl['pujaregarr'][$i]['Status'];
              ...
              <tr class="<?php echo $i % 2 === 0 ? 'odd' : 'even'; ?>">
                   ...
                   <td><a class="btn btn-success btn-sm" href="<?php echo INSTALL_URL; ?>PujaMagazineadmin/pujamagazinepriceedit/<?php echo $tpl['pujaregarr'][$i]['id']; ?>" rev="<?php echo $v['id']; ?>"><span class="glyphicon glyphicon-eye-open"></span></a></td>
                   <?php }?>
                   <?php if (!$this->controller->isAdmin())  { ?>
                   ...
                   <?php }?>
                   <?php if (!$this->controller->isAdmin())  { ?>
                    <td><a cat="4" rev="<?php echo $tpl['apujaregarrrr'][$i]['id']; ?>" href=""><span></span></a></td>
                    <?php }?>
                </tr>
                <?php
            }
