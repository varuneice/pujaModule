        ...
        if ($count > 0) {
            for ($i = 0; $i < $count; $i++) {
              ...
              <tr class="<?php echo $i % 2 === 0 ? 'odd' : 'even'; ?>">
                   ...
                   <td><a class="btn btn-success btn-sm" href="<?php echo INSTALL_URL; ?>PujaMagazineadmin/edit/<?php echo $tpl['arr'][$i]['id']; ?>" rev="<?php echo $v['id']; ?>"><span class="glyphicon glyphicon-eye-open"></span></a></td>
                   <?php } ?> 
                   <?php if (!$this->controller->isAdmin() && !$this->controller->isEditor())  { ?>
