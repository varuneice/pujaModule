...
<table id="<?php echo (count($tpl['arr'] ?? [])) ? "tab-1-table-id" : ""; ?>" class="gzblog-table table-striped table-hover" cellpadding="0" cellspacing="0" >
    <thead>
        ...
        <th style="display:none;"><?php echo __('ID'); ?></th>
            ...
            <th><?php echo __('No. of Magazine'); ?></th>
            <th><?php echo __('Per Copy Amount'); ?></th>
        ...
        if ($count > 0) {
            for ($i = 0; $i < $count; $i++) {
              ...
              <tr class="<?php echo $i % 2 === 0 ? 'odd' : 'even'; ?>">
                   ...
                   <td><?php echo $tpl['arr'][$i]['per_mag_amount']; ?></td>
                  ...
                  <?php } ?>
                   ...
                   <td><a class="btn btn-success btn-sm" href="<?php echo INSTALL_URL; ?>PujaMagazineadmin/edit/<?php echo $tpl['arr'][$i]['id']; ?>" rev="<?php echo $tpl['arr'][$i]['id']; ?>"><span class="glyphicon glyphicon-eye-open"></span></a></td>
                   <?php } ?> 
                   <?php if (!$this->controller->isAdmin() && !$this->controller->isEditor())  { ?>
                   ...
                   <td><a cat="1" class="btn btn-danger btn-sm icon-delete" rev="<?php echo $tpl['arr'][$i]['id']; ?>" href="<?php echo INSTALL_URL; ?>PujaMagazineadmin/delete/<?php echo $tpl['arr'][$i]['id']; ?>"><span class="glyphicon glyphicon-remove"></span></a></td>
                   <?php }?>
                   <?php if (!$this->controller->isAdmin())  { ?>
            ...
            <td colspan="9">
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="<?php echo INSTALL_URL ?>PujaMagazineadmin/export"><?php echo __('export'); ?></a></li>
