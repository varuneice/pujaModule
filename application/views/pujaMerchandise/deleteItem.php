...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><?php echo __('Saree / Punjabi Delete'); ?></li>
    </ol>
</section>
<?php
...
<section class="content left width_100">
    <form id="edit_user" class="frm-class user-frm-class" action="" method="post" name="eventPaymentEdit"
        ...
        <div class="padding-19 nav-tabs-custom left width_100">
            <fieldset>
                <h1 style="margin:0; font-size:24px; color:#2679b5;"> Delete Saree / Punjabi Item </h1><br>
                            ...
                            for ($i = 0; $i < $count; $i++) {
                                ...
                                <tr class="<?php echo $i % 2 === 0 ? 'odd' : 'even'; ?>">
                                    ...
                                    <td>
                                        ...
                                        <?php echo htmlspecialchars($tpl['clothdata'][$i]['price_regular']); ?>

                                    </td>

                                    <td>
                                        <?php echo htmlspecialchars($tpl['clothdata'][$i]['price_early']); ?>

                                    </td>


                                    <td>
                                        <?php echo htmlspecialchars($tpl['clothdata'][$i]['limit_regular']); ?>


                                    <td>
                                        <?php echo htmlspecialchars($tpl['clothdata'][$i]['limit_early']); ?>
            ...
            <?php if ($this->controller->isAdmin()) { ?>
                ...
                <button id="submit" class="btn btn-danger delete-btn" autocomplete="off" value="<?php echo __('delete'); ?>"
                    name="delete" tabindex="9" type="submit">
                    <i class="fa fa-trash-alt"></i>&nbsp;&nbsp;<?php echo __('Delete'); ?>
                </button>
