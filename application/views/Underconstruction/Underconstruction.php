...
.page-title {position: relative; color: #ffffff; padding: 10px 0px 10px; background-position: center center; background-size: cover; background-repeat: no-repeat;}
        ...
        <div class="auto-container">
            <div class="row clearfix">
               ...
               <div class="title-column col-lg-6 col-md-12 col-sm-12">
					...
					<img style="border-radius: 96px;float: left;padding: 0px;padding-top: .8rem;" src="../puja_logo.png" width="30%">
                </div>
                <!--Bread Crumb -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 text-center">
                <img src="../uc.svg" alt="Under Construction" width="100%">
            </div>
        </div>
    </div>
