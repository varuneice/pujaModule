<head>
    ...
    opacity: 0.4;
        ...
        /* Ensure that the parent container allows the anchor tag to be styled properly */
        .col-md-6 {
            display: flex;
            justify-content: center;
            align-items: center;
                ...
                <div class="breadcrumb-column col-lg-6 col-md-12 col-sm-12">
                    ...
                    <ul class="bread-crumb clearfix">
                        <li><a style="text-decoration:none;color:#fff;"
                                href="https://durgabari.org/HDBS_Puja_Payments/onlinepujapayments/onlinepujapayments">Home</a>
                        </li>
                        <li class="active">Puja Sponsorship</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="container large">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 text-center">
                <img src="../9agustPujaspon.jpg" alt="Sponsorship" class="img-rounded bs"
                    style="border-radius:.5rem;" width="100%" />
            </div>
        </div>
        <br><br>
    ...
    <div class="container">
        <div class="row" style="justify-content: space-between;">
            <div class="col-md-4">
                <a href="https://durgabari.org/HDBS_Puja_Payments/PujaDonations/pujadonation" class="w-100"
                    target="_blank">
                    <img src="../sponser-btn.png" alt="" class="w-100 bs" style="border-radius: 2.7rem;">
                </a>
            </div>
            <div class="col-md-4">
                <a href="https://durgabari.org/HDBS_Puja_Payments/PujaOnlinePayments/PujaOnlinePayments" class="w-100"
                    target="_blank">
                    <img src="../register-btn.png" alt="" class="w-100 bs" style="border-radius: 2.7rem;">
                </a>
            </div>
        </div>
    </div>
