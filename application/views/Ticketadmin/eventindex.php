...
<section class="content">
    <div class="navbar-inner" style="display:none;">
        <ul class="nav nav-pills" >
            <li class="<?php echo (($_REQUEST['action'] ?? '') == 'index') ? "active" : ""; ?>"><a href="<?php echo INSTALL_URL; ?>Eventadmin/index"><?php echo __('all_ticket'); ?></a></li>
            <li>
    ...
    <div class="nav-tabs-custom">
        <ul class="nav nav-tabs" id="myTabTicketEvent">
            <li class="active">
                <a data-toggle="tab" href="#ticketevent_tab_1"><?php echo __('Ticket Event'); ?></a>
            </li>
        </ul>
        <div class="tab-content">
            <div id="ticketevent_tab_1" class="tab-pane active">
                <div class="box">
