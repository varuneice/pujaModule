...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo INSTALL_URL; ?>Ticketadmin/index"><?php echo __('title_editticket'); ?></a></li>
        <li class="active"><?php echo __('Edit Ticket'); ?></li>
    </ol>
</section>
<?php
require_once VIEWS_PATH . 'Layouts/admin/error_notice.php';
$eventname = $tpl['ticketeventarr']['ticketevents'];
?>
<section class="content left width_100">
    <form id="edit_user" class="frm-class user-frm-class" action="<?php echo INSTALL_URL; ?>Ticketadmin/ticketedit" method="post" name="ticketedit" enctype="multipart/form-data">
        <div class="padding-19 nav-tabs-custom left width_100">
            <fieldset>
                <table class="table">
                    ...
                    <tr class="tr">
                        <td class="td">
                            <!-- <input   id="ticketevent" class="form-control input-sm" type="text" name="ticketevents" size="25" value="<?php echo $tpl['ticketeventarr']['ticketevents']; ?>" title="Events" placeholder="Event"> -->
                            <select data-rule-required='true' name="ticketevents" id="ticketevent" class="form-control input-sm" required>
                ...
                <?php  $i++; ?>
                          <select class="form-control input-sm" id="ticketday" name="itemeventday[]" value="<?php echo $itemday; ?>" onchange="ticketpriceevent(this.id)">
                            <!--   <option id="<?php echo $id; ?>" value="<?php echo $itemday; ?>"><?php echo $itemday; ?></option>  -->
                            <?php foreach ($arr2 as $key => $day) { ?> 
                            <option <?php echo ($itemday  == $day) ? "selected='selected'" : ""; ?> value="<?php echo $day; ?>" onchange="ticketprice(this.id)"><?php echo $day; ?></option> 
                            <?php } ?>
                            </select>
                            <br>
...
function finddate() {
        ...
        var len =allticketday;
      for(i=1;i<len; i++){
        var divid = "maindiv_"+i;
        //alert(divid);
        var allticketday = document.getElementById(divid);
        allticketday.remove();
        }
