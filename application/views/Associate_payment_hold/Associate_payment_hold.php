...
<head>
<title>Associate Payment Hold</title>
...
a.a_go_cart_btn{    padding: 10px 40px 10px 40px; font-size: 34px; border-radius: 10px; background-color: #000; color: #fff; margin: 0px 0px 0px 0px; font-weight: 600;}
                ...
                <div class="breadcrumb-column col-lg-6 col-md-12 col-sm-12">
                   ...
                   <!-- <h4><span>Contact : </span><a href="mailto:registration@durgabari.org"> registration@durgabari.org</a></h4>-->
                    <ul class="bread-crumb clearfix">
                        ...
                        <li class="active">Associate Payment Hold</li>
                    </ul>
                </div>
            </div>
        </div>
    </section>
        <!-- <h1 style="text-align: center; color: black; letter-spacing: 1px; font-size: 32px; font-weight: 700;"><img src="https://durgabari.org/HDBS_Puja_Payments/asso_hold.svg" alt="Associate Payment Hold" width="70%"></h1> -->
        <h1 style="text-align: center; color: black; letter-spacing: 1px; font-size: 32px; font-weight: 700;"><img src="../Associated_Payments_Flyer.jpg" alt="Associate Payment Hold" style="width:auto;height:60vh;"/></h1>