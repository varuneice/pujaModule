                ...
                if ($_POST['PaymentOption'] == 'stripe') {
                    ...
                    ?>
                     <table border="4" width='585px'>
                                ...
                                <tr><td>Puja Type</td> <td><?php echo $_POST['item_name']; ?></td></tr>
                    ...
                    ?>
                     <table border="4" width='585px'>
                                ...
                                <tr><td>Member Id</td><td><?php echo $_POST['Member_id']; ?></td></tr>
                                <tr><td>Member Name</td> <td><?php echo $_POST['name'];?></td></td></tr>
                                <tr><td>Puja Name</td> <td><?php echo $_POST['item_name']; ?></td></tr>
                                <tr><td>Amount</td> <td><span style="color:red;">$</span><?php echo $_POST['item_cost']; ?></td></tr>
...
$state = $tpl['sankalpapujaarr']['state']; 
$paymentstatus = $tpl['sankalpapujaarr']['Status'];
$registermember = $tpl['sankalpapujaarr']['regmember']; 

?>
<form id="registration-frm-id" class="frm-class booking-frm-class" action="<?php echo INSTALL_URL; ?>Pujaregistration/sankalpapayment" method="post" name="sankalpapayment">
<td colspan='2'>
                            ...
                            <div class="box box-solid box-primary">
                                ...
                                <div class="form-group">
                                        ...
                                        <input id="registrationfor" class="form-control input-sm" type="text"
                                            ...
                                            value="<?php echo $tpl['sankalpapujaarr']['item_name']; ?>" title="Registration Type"
                                    ...
                                    <input id="category" class="form-control input-sm" type="text" name="category"
                                            size="25" value="<?php echo $tpl['sankalpapujaarr']['category']; ?>" title="Category"
                                            placeholder="" required readonly> 
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input id="memberid" class="form-control input-sm" type="text" name="Member_id"
                                            size="25" value="<?php echo $tpl['sankalpapujaarr']['Member_id']; ?>" title="Member Id"
                                ...
                                <div class="form-group">
                                        ...
                                        <input id="participationmode" class="form-control input-sm" type="text" name="modeparticipation"
                                            size="25" value="<?php echo $tpl['sankalpapujaarr']['modeparticipation']; ?>"
                                    ...
                                    <!-- <div class="form-group">
                                        ...
                                        <input id="registrationfor" class="form-control input-sm" type="text" name="registrationtype"
                                            size="25" value="<?php echo $tpl['sankalpapujaarr']['registrationtype']; ?>" title=""
                                            placeholder="" required  readonly>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input id="optional" class="form-control input-sm" type="text" name=""
                                            size="25" value="<?php echo $tpl['sankalpapujaarr']['']; ?>" title=""
                                    ...
                                    <!-- <div class="form-group">
                                        ...
                                        <input id="adultveg" class="form-control input-sm" type="number" name="Adultveggie"
                                            size="25" value="<?php echo $tpl['sankalpapujaarr']['Adultveggie']; ?>" title="Adult Veggie"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="magazine" class="form-control input-sm" type="number" name="magazine"
                                            size="25" value="<?php echo $tpl['sankalpapujaarr']['magazine']; ?>" title="No. of Magazine(s)"
                        ...
                        <div class="box box-solid box-primary">
                                ...
                                <!-- <div class="form-group">
                                      ...
                                      <input id="items" class="form-control input-sm" type="text" name="items"
                                            size="25" value="<?php echo $tpl['sankalpapujaarr']['items']; ?>"
                                    ...
                                    <!-- <div class="form-group">
                                        ...
                                        <input id="donationpuja" class="form-control input-sm" type="text" name="donation"
                                            size="25" value="<?php echo $tpl['sankalpapujaarr']['donation']; ?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="noparent" class="form-control input-sm" type="text" name="noparent"
                                            size="25" value="<?php echo $tpl['sankalpapujaarr']['parent']; ?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="totalamount" class="form-control input-sm" type="number"
                                                ...
                                                value="<?php echo $tpl['sankalpapujaarr']['item_cost']; ?>"
                                    ...
                                    <div class="form-group">
                                          <label class="control-label" for="status">
                                            ...
                                            <input id="status" class="form-control input-sm" type="text"
                                                name="Status" size="25"
                                                value="<?php echo $tpl['sankalpapujaarr']['Status']; ?>"
...
<!-- end -->
                        <!-- <div class="box box-solid box-primary">
                                ...
                                <div class="form-group">
                                        ...
                                        <input id="quantity" class="form-control input-sm" type="text"
                                            ...
                                            value="<?php echo $tpl['userticketarr']['item_number']; ?>"
                                            title="<?php echo __('Quantity'); ?>" placeholder="" required readonly>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label" for="ticketamount">
                                            <?php echo __('Ticket Amount'); ?>:
                                        </label>
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                                <?php echo Util::getCurrensySimbol($tpl['option_arr_values']['currency']); ?>
                                            </span>
                                            <input data-rule-required="true" id="ticketamount"
                                                class="form-control input-sm" type="text" name="item_cost" size="25"
                                                value="<?php echo $tpl['userticketarr']['item_cost']; ?>"
                                                title="Amount" placeholder="Amount" required readonly>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label" for="totalamount">
                ...
                <td id="error_codeimg"></td>
                                ...
                                <input type="hidden" name="sankalpa_payment" value="1" /> 
                                    <input type="hidden" name="id" value="<?php echo $tpl['sankalpapujaarr']['id']; ?>" />
                            ...
                            <div class="box box-solid box-primary">
                                ...
                                <div class="form-group">
                                        ...
                                        <input id="membername" class="form-control input-sm" type="text" name="name"
                                            size="25" value="<?php echo $tpl['sankalpapujaarr']['name']; ?>"
                                ...
                                <!-- <div class="form-group">
                                        ...
                                        <input id="spousename" class="form-control input-sm" type="text" name="Sp_fname"
                                            size="25" value="<?php echo $tpl['sankalpapujaarr']['Sp_fname']. ' ' . $tpl['sankalpapujaarr']['Sp_lname']; ?>"
                                    ...
                                    <!-- <div class="form-group">
                                        ...
                                        <input id="child1" class="form-control input-sm" type="text" name="Child1"
                                            size="25" value="<?php echo $tpl['sankalpapujaarr']['Child1']; ?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="dobchild1" class="form-control input-sm" type="text" name="Age1"
                                            size="25" value="<?php echo $tpl['sankalpapujaarr']['Age1']; ?>"
                                    ...
                                    <div class="form-group">
                                            ...
                                            size="25" value="<?php echo $tpl['sankalpapujaarr']['Child2']; ?>"
                                        ...
                                        <input id="dobchild2" class="form-control input-sm" type="text" name="Age2"
                                            size="25" value="<?php echo $tpl['sankalpapujaarr']['Age2']; ?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            size="25" value="<?php echo $tpl['sankalpapujaarr']['Child3']; ?>"
                                        ...
                                        <input id="dobchild3" class="form-control input-sm" type="text" name="Age3"
                                            size="25" value="<?php echo $tpl['sankalpapujaarr']['Age3']; ?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="parent1" class="form-control input-sm" type="text" name="Parent1"
                                            size="25" value="<?php echo $tpl['sankalpapujaarr']['Parent1']; ?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="parent2" class="form-control input-sm" type="text" name="Parent2"
                                            size="25" value="<?php echo $tpl['sankalpapujaarr']['Parent2']; ?>"
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="street" class="form-control input-sm" type="text" name="street"
                                            size="25" value="<?php echo $tpl['sankalpapujaarr']['street']; ?>" title="Address"
                                            placeholder="" required readonly>
                                    </div> 
                                    <div class="form-group">
                                        ...
                                        <input id="streetname" class="form-control input-sm" type="text" name="streetname"
                                            size="25" value="<?php echo $tpl['sankalpapujaarr']['streetname']; ?>" title="Address"
                                            placeholder="" required readonly>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input id="unit" class="form-control input-sm" type="text" name="unit"
                                            size="25" value="<?php echo $tpl['sankalpapujaarr']['unit']; ?>" title="Address"
                                            placeholder="" required readonly>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input id="city" class="form-control input-sm" type="text" name="city" size="25"
                                            value="<?php echo $tpl['sankalpapujaarr']['city']; ?>" title="<?php echo __('City'); ?>"
                                            placeholder="" required readonly>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input id="state" class="form-control input-sm" type="text" name="state" readonly size="25" value="<?php echo ($tpl['arr'] ?? [])['state'] ?? ''; ?>" title="<?php echo __('State'); ?>" placeholder="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="zip" class="form-control input-sm" type="text" name="zip" size="25"
                                            value="<?php echo $tpl['sankalpapujaarr']['zip']; ?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="phone" class="form-control input-sm" type="text" name="tele"
                                            size="25" value="<?php echo $tpl['sankalpapujaarr']['tele']; ?>" title="tele"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="phone" class="form-control input-sm" type="text" name="alternatenumber"
                                            size="25" value="<?php echo $tpl['sankalpapujaarr']['alternatenumber']; ?>" title="Alternate Conatct"
                                            maxlength="10" placeholder="### ###-####" required readonly>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input id="phone" class="form-control input-sm" type="text" name="email"
                                            size="25" value="<?php echo $tpl['sankalpapujaarr']['email']; ?>" title="email"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="phone" class="form-control input-sm" type="text" name="alternateemail"
                                            size="25" value="<?php echo $tpl['sankalpapujaarr']['alternateemail']; ?>" title="Alternate Email"
                                            placeholder="name@company.com" pattern="[^@\s]+@[^@\s]+\.[^@\s]+" required readonly>
                                    </div>
                                </div>
                        </section>
