                ...
                if (($_POST['PaymentOption'] ?? '') == 'stripe') {
                    ...
                    ?>
                     <table border="4" width='585px'>
                                ...
                                <tr><td>Puja Price</td> <td><span style="color:red;">$</span><?php echo $pujaprice; ?></td></tr>
                                 <?php if($magazineprice  != 0){ ?>
                                <tr><td>Magazine(Additional)</td><td><span style="color:red;">$</span><?php echo $magazineprice; ?></td></tr>
                                <?php } ?>
                                <?php if($parentregistration  != 0){ ?>
                                <tr><td>Parent Registration</td><td><span style="color:red;">$</span><?php echo $parentregistration; ?></td></tr>
                                <?php } ?>
                                <?php if($seniordiscount  != 0){ ?>
                                <tr><td>Senior Discount</td><td><span style="color:red;">$</span><?php echo $seniordiscount; ?></td></tr>
                                <?php } ?>
                                <?php if ($donation != 0) { ?>
                                    <tr><td>Donation Amount</td><td><span style="color:red;">$</span><?php echo $donation; ?></td></tr>
                                <?php } ?>
...
$state = $tpl['registrationarr']['state']; 
$paymentstatus = $tpl['registrationarr']['status'];
$registermember = $tpl['registrationarr']['regmember']; 

?>
<form id="registration-frm-id" class="frm-class booking-frm-class" action="<?php echo INSTALL_URL; ?>Pujaregistration/payment" method="post" name="payment">
<td colspan='2'>
     <img src="<?php echo INSTALL_URL; ?>thankyouscreen.jpg" class="profile" />
     <h2  style="text-align:center;font-family:fangsong; font-size:30px;margin-top:-10px;">HDBS Puja Registration Payment</h2>
    </td> 
                            ...
                            <div class="box box-solid box-primary">
                                ...
                                <div class="form-group">
                                        ...
                                        <input id="registrationfor" class="form-control input-sm" type="text"
                                            ...
                                            value="<?php echo $tpl['registrationarr']['puja_type']; ?>" title="Registration Type"
                                    ...
                                    <input id="category" class="form-control input-sm" type="text" name="membercategory"
                                            size="25" value="<?php echo $tpl['registrationarr']['membercategory']; ?>" title="Category"
                                            placeholder="" required readonly> 
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input id="memberid" class="form-control input-sm" type="text" name="Member_id"
                                            size="25" value="<?php echo $tpl['registrationarr']['Member_id']; ?>" title="Member Id"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="memberid" class="form-control input-sm" type="text" name="schoolname"
                                            size="25" value="<?php echo $tpl['registrationarr']['schoolname']; ?>" title="Member Id"
                                            maxlength="10" placeholder="Member ID" required readonly>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="magazine" class="form-control input-sm" type="number" name="magazine"
                                            size="25" value="<?php echo htmlspecialchars($tpl['registrationarr']['magazine'] ?? '', ENT_QUOTES); ?>" title="No. of Magazine(s)"
                                ...
                                <div class="box-body">
                                   ...
                                   <div class="form-group">
                                        ...
                                        <input id="registrationamount" class="form-control input-sm" type="text" name="amount"
                                            size="25" value="<?php echo $tpl['registrationarr']['amount']; ?>"
                                            title="<?php echo __('Registration Amount'); ?>" placeholder="" readonly>
                                    </div>
                                 </div>
                                    <?php if ($tpl['registrationarr']['donation'] !="" && $tpl['registrationarr']['donation'] > 0)  { ?>
                                    <div class="form-group">
                                        ...
                                        <input id="donationpuja" class="form-control input-sm" type="text" name="donation"
                                            size="25" value="<?php echo $tpl['registrationarr']['donation']; ?>"
                                            title="<?php echo __('Donations'); ?>" placeholder="" readonly>
                                    </div>
                                    </div>
                                    <?php
                                      } ?>
                                      <?php if (($tpl['registrationarr']['discountseniorprice'] ?? '') != "")  { ?>
                                    <div class="form-group">
                                        ...
                                        <input id="seniordiscount" class="form-control input-sm" type="text" name="discountseniorprice"
                                            size="25" value="<?php echo htmlspecialchars($tpl['registrationarr']['discountseniorprice'] ?? '', ENT_QUOTES); ?>"
                                            title="<?php echo __('Senior Discount'); ?>" placeholder="" readonly>
                                    </div>
                                      </div>
                                    <?php
                                      } ?>
                                       <?php if (($tpl['registrationarr']['extraparentregistration'] ?? '') != "")  { ?>
                                    <div class="form-group">
                                        ...
                                        <input id="parentregistration" class="form-control input-sm" type="text" name="extraparentregistration"
                                            size="25" value="<?php echo htmlspecialchars($tpl['registrationarr']['extraparentregistration'] ?? '', ENT_QUOTES); ?>"
                                            title="<?php echo __('Parent Registration'); ?>" placeholder="" readonly>
                                    </div>
                                       </div>
                                    <?php
                                      } ?>
                                       <?php if (($tpl['registrationarr']['magazineprice'] ?? '') != "")  { ?>
                                    <div class="form-group">
                                        ...
                                        <input id="pricemagazine" class="form-control input-sm" type="text" name="magazineprice"
                                            size="25" value="<?php echo htmlspecialchars($tpl['registrationarr']['magazineprice'] ?? '', ENT_QUOTES); ?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="totalamount" class="form-control input-sm" type="number"
                                                ...
                                                value="<?php echo $tpl['registrationarr']['totalamount']; ?>"
                                          ...
                                          <label class="control-label" for="status">
                                            ...
                                            <!-- <select data-rule-required="true" name="status" id="status"
                                                ...
                                                foreach ($status_arr as $k => $v) {
                                                    ?>
                                                    <option <?php echo ($tpl['registrationarr']['status'] == $k) ? "selected='selected'" : ""; ?> value="<?php echo $k; ?>"><?php echo $v; ?></option>
                                                    <?php
                                                }
                                                ?>
                                            </select> -->
                                            <input id="status" class="form-control input-sm" type="text"
                                                name="status" size="25"
                                                value="<?php echo $tpl['registrationarr']['status']; ?>"
...
<!-- end -->
                            ...
                            <div class="box box-solid box-primary">
                                ...
                                <div class="box-body">
                                    <div class="form-group" id="paymentdropdown">
                                        ...
                                        <select data-rule-required="true" name="PaymentOption" id="PaymentOption" class="form-control input-sm" >
                ...
                <td id="error_codeimg"></td>
                                ...
                                <input type="hidden" name="registration_payment" value="1" /> 
                                    <input type="hidden" name="id" value="<?php echo $tpl['registrationarr']['id']; ?>" />
                            ...
                            <div class="box box-solid box-primary">
                                ...
                                <div class="form-group">
                                        ...
                                        <input id="membername" class="form-control input-sm" type="text" name="membername"
                                            size="25" value="<?php echo $tpl['registrationarr']['First_name']. ' ' . $tpl['registrationarr']['Last_name']; ?>"
                                            title="<?php echo __('Member Name'); ?>" placeholder="" readonly>
                                    </div>
                                    <?php if ($tpl['registrationarr']['Sp_fname'] !="")  { ?>
                                <div class="form-group">
                                        <label class="control-label" for="paymentfor">
                                            <?php echo __('Spouse Name'); ?>:
                                        </label>
                                        <input id="spousename" class="form-control input-sm" type="text" name="spousename"
                                            size="25" value="<?php echo $tpl['registrationarr']['Sp_fname']. ' ' . $tpl['registrationarr']['Sp_lname']; ?>"
                                            title="<?php echo __('Spouse Name'); ?>" placeholder="" readonly>
                                    </div>
                                    <?php
                                      } ?>
                                       <?php if ($tpl['registrationarr']['childonefname'] !="")  { ?>
                                    <div class="form-group">
                                        <label class="control-label" for="paymentfor">
                                            <?php echo __('Child 1 Full Name'); ?>:
                                        </label>
                                        <input id="child1" class="form-control input-sm" type="text" name="Child1"
                                            size="25" value="<?php echo $tpl['registrationarr']['childonefname']. ' ' . $tpl['registrationarr']['childonelname']; ?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="dobchild1" class="form-control input-sm" type="text" name="Age1"
                                            size="25" value="<?php echo $tpl['registrationarr']['Age1']; ?>"
                                            title="<?php echo __('Year of Birth Child 1'); ?>" placeholder="" readonly>
                                    </div>
                                    <?php
                                    } ?>
                                       <?php if ($tpl['registrationarr']['childtwofname'] !="")  { ?>
                                    <div class="form-group">
                                            <label class="control-label" for="status">
                                                <?php echo __('Child 2 Full Name'); ?>:
                                            </label>
                                            <input id="child2" class="form-control input-sm" type="text" name="Child2"
                                            size="25" value="<?php echo $tpl['registrationarr']['childtwofname']. ' ' . $tpl['registrationarr']['childtwolname']; ?>"
                                        ...
                                        <input id="dobchild2" class="form-control input-sm" type="text" name="Age2"
                                            size="25" value="<?php echo $tpl['registrationarr']['Age2']; ?>"
                                            title="<?php echo __('Year of Birth Child 2'); ?>" placeholder="" readonly>
                                    </div>
                                    <?php
                                    } ?>
                                      <?php if ($tpl['registrationarr']['childthreefname'] !="")  { ?>
                                        <div class="form-group">
                                            <label class="control-label" for="status">
                                                <?php echo __('Child 3 Full Name'); ?>:
                                            </label>
                                            <input id="child3" class="form-control input-sm" type="text" name="Child3"
                                            size="25" value="<?php echo $tpl['registrationarr']['childthreefname']. ' ' . $tpl['registrationarr']['childthreelname']; ?>"
                                        ...
                                        <input id="dobchild3" class="form-control input-sm" type="text" name="Age3"
                                            size="25" value="<?php echo $tpl['registrationarr']['Age3']; ?>"
                                            title="<?php echo __('Year of Birth Child 3'); ?>" placeholder="" readonly>
                                    </div>
                                    <?php
                                    } ?>
                                      <?php if ($tpl['registrationarr']['parent1_fname'] !="")  { ?>
                                    <div class="form-group">
                                        ...
                                        <input id="parent1" class="form-control input-sm" type="text" name="Parent1"
                                            size="25" value="<?php echo $tpl['registrationarr']['parent1_fname']. ' ' . $tpl['registrationarr']['parent1_lname']; ?>"
                                            title="<?php echo __('Parent 1 Full Name'); ?>" placeholder="" readonly>
                                    </div>
                                    <?php
                                    } ?>
                                     <?php if ($tpl['registrationarr']['parent2_fname'] !="")  { ?>
                                    <div class="form-group">
                                        ...
                                        <input id="parent2" class="form-control input-sm" type="text" name="Parent2"
                                            size="25" value="<?php echo $tpl['registrationarr']['parent2_fname']. ' ' . $tpl['registrationarr']['parent2_lname']; ?>"
                            ...
                            <div class="box box-solid box-primary">
                                ...
                                <div class="form-group">
                                        ...
                                        <input id="street" class="form-control input-sm" type="text" name="street"
                                            size="25" value="<?php echo $tpl['registrationarr']['street']; ?>" title="Address"
                                            placeholder="" required readonly>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input id="streetname" class="form-control input-sm" type="text" name="streetname"
                                            size="25" value="<?php echo $tpl['registrationarr']['streetname']; ?>" title="Address"
                                            placeholder="" required readonly>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input id="unit" class="form-control input-sm" type="text" name="unit"
                                            size="25" value="<?php echo $tpl['registrationarr']['unit']; ?>" title="Address"
                                            placeholder="" required readonly>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input id="city" class="form-control input-sm" type="text" name="city" size="25"
                                            value="<?php echo $tpl['registrationarr']['city']; ?>" title="<?php echo __('City'); ?>"
                                            placeholder="" required readonly>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="zip" class="form-control input-sm" type="text" name="zip" size="25"
                                            value="<?php echo $tpl['registrationarr']['zip']; ?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="phone" class="form-control input-sm" type="text" name="phone"
                                            size="25" value="<?php echo $tpl['registrationarr']['phone']; ?>" title="phone"
                                            maxlength="10" placeholder="### ###-####" required readonly>
                                    </div>
                                    <?php if ($tpl['registrationarr']['alternatenumber'] !="")  { ?>
                                    <div class="form-group">
                                        <label class="control-label" for="phone">
                                            <?php echo __('Alternate Conatct'); ?>:
                                        </label>
                                        <input id="phone" class="form-control input-sm" type="text" name="alternatenumber"
                                            size="25" value="<?php echo $tpl['registrationarr']['alternatenumber']; ?>" title="Alternate Conatct"
                                            maxlength="10" placeholder="### ###-####" required readonly>
                                    </div>
                                    <?php
                                      } ?>
                                    <div class="form-group">
                                        ...
                                        <input id="phone" class="form-control input-sm" type="text" name="email"
                                            size="25" value="<?php echo $tpl['registrationarr']['email']; ?>" title="email"
                                            placeholder="name@company.com" pattern="[^@\s]+@[^@\s]+\.[^@\s]+" required readonly>
                                    </div>
                                    <?php if ($tpl['registrationarr']['alternateemail'] !="")  { ?>
                                    <div class="form-group">
                                        <label class="control-label" for="email">
                                            <?php echo __('Alternate Email'); ?>:
                                        </label>
                                        <input id="phone" class="form-control input-sm" type="text" name="alternateemail"
                                            size="25" value="<?php echo $tpl['registrationarr']['alternateemail']; ?>" title="Alternate Email"
                                            placeholder="name@company.com" pattern="[^@\s]+@[^@\s]+\.[^@\s]+" required readonly>
                                    </div>
                                    <?php
                                      } ?>
