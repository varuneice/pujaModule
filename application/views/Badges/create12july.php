                    ...
                    <fieldset class="asb">
                        <table  class="table"> 
                            <tr colspan="8" class="tr">
                                ...
                                <input id="Member id" class="form-control input-sm" type="text" name="Member_id" size="12" value="" title="MemberID" placeholder="MemberID" readonly>

                                   
                                </td>
                                <td class="td">Date of Renewal<span style="color:#ff0000"></span></td>
                                <td class="td">
                                <input id="Renew_date" class="form-control input-sm" type="text" name="Renew_date" size="12" value="" title="Renew Date" placeholder="Renewal Date" readonly> 
                                </td>
                            </tr>
                            </table>
                            <table  class="table"> 
                            <tr class="tr">
                                ...
                                <td  class="td">
                                <input  id="middle name" class="form-control input-sm" type="text" name="M_Name" size="25" value="" title="Middle Name" placeholder="Middle Name">
                                </td>
                            </tr>
                            <tr class="tr">
                            <td  class="td">Last Name <span style="color:#ff0000">*</span></td> 
                                <td  class="td"> 
                                <input required="true" id="last name" class="form-control input-sm" type="text" name="L_Name" size="25" value="" title="Last Name" placeholder="Last Name">
                                    <!--  -->
                                </td>
                                <td class="td">
                                ...
                                <td class="td"> 
                                <input type="radio" id="individual_membership" name="membership_type"   value="individual_membership"checked/>
                                     Individual Membership,<br>
                               <input type="radio" id="individual_membership"   name="membership_type" value="family_membership"  />
                                     Family Membership                      
                                </td>
                            ...
                            <td  class="td">
                                ...
                                <td  class="td">
                                <input required="true" id="Spouselast" class="form-control input-sm" type="text" name="Sp_LName" size="25" value="" title="Last Name" placeholder="Last Name">
                                 </td>
                                 </tr>
                            <tr class="tr">
                            ...
                            <tr class="tr">
                                ...
                                <td  class="td" >
                                    <input  id="Address" class="form-control input-sm" type="text" name="Address2" size="25" value="" title="Address" placeholder="Address Line 2">
                                </td>                        
                            </tr>
                            <tr class="tr">
                            ...
                            <tr class="tr">
                                ...
                                <td class="td">
                                <input required="true" id="phone_mobile" class="form-control input-sm" type="number" name="Tele1" size="25" value="" title="phone_No" placeholder="phone_No">
                                </td>   
                                <td class="td">
                                <input id="phone_No" class="form-control input-sm" type="number" name="Mob_No"  value="" title="Tele1" placeholder="Tele1">
                                </td>
                                <td class="td">
                                <input  id="phone_work" class="form-control input-sm" type="number" name="Tele2" size="25" value="" title="phone_work" placeholder="phone_work">
                                </td>                        
                            </tr>
                            <tr class="tr">
                                <td  class="td">Email<span style="color:#ff0000">*</span></td>
                                <td  class="td">
                                    <input required="true" id="email" class="form-control input-sm" type="text" name="email" size="25" value="" title="email" placeholder="Email">
                                </td>   
                            ...
                            <tr class="tr">
                                <td  colspan="4" class="td">Child 1<input id="Child" class="form-control input-sm" type="text" name="Child1" size="25" value="" title="Child" placeholder="Child 1"></td>
                                <td class="td">Year of Birth<input max="<?php echo date('Y-m-d'); ?>" id="year_birth1" class="form-control input-sm date-picker"  name="Age1" size="25" value="" title="year_birth" placeholder=""></td>   
                                <td class="td">Child 2<input id="Child2" class="form-control input-sm" type="text" name="Child2" size="25" value="" title="Children" placeholder="Child 2"></td>
                                <td class="td"> Year of Birth<input max="<?php echo date('Y-m-d'); ?>"  id="year_birth2" class="form-control input-sm date-picker"  name="Age2" size="25" value="" title="year_birth" placeholder=""></td>                       
                            </tr>
                            <tr class="tr">
                                <td   colspan="4" class="td">Child 3<input id="Child3" class="form-control input-sm" type="text" name="Child3" size="25" value="" title="Child" placeholder="Child 3"></td>
                                <td  class="td"> Year of Birth<input max="<?php echo date('Y-m-d'); ?>"  id="year_birth3" class="form-control input-sm date-picker"  name="Age3" size="25" value="" title="year_birth" placeholder=""></td>   
                                <td  class="td">Children 4<input id="Child4" class="form-control input-sm" type="text" name="Child4" size="25" value="" title="Child" placeholder="Child 4"></td>
                                <td  class="td">Year of Birth<input max="<?php echo date('Y-m-d'); ?>"  id="year_birth4" class="form-control input-sm date-picker"  name="Age4" size="25" value="" title="year_birth" placeholder=""></td>                       
                            </tr>
                             </tr>
                            </table>
                            ...
                            <tr class="tr">
                                ...
                                <td class="td"><label class="control-label" for="Child" style="float:left;"> Rate</label><span style="color:#ff0000">*</span> </td>
                                <td class="td"><label class="control-label" for="Child" style="float:left;">Paid</label> </td>                        
                            </tr>
                            <tr class="tr">
                            ...
                            <tr class="tr">
                                ...
                                <td class="td">
                                    <input id="donation" class="form-control input-sm" type="text" name="donation" size="25" value="" title="Paid" placeholder="$">
                                </td>                        
                            </tr>
                            <tr class="tr">  
                            ...
                            <?php } ?>
                            <tr class="tr">
                            <td  class="td">Add Refrences</td> 
                            <td  colspan="2"> 
                                 <input  id="refrence"  class="form-control input-sm" type="text" name="remarks" size="25" value="" title="Refrence" placeholder="Refrence"></td>
