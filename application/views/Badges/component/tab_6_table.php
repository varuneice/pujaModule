        ...
        if ($count > 0) {
            for ($i = 0; $i < $count; $i++) {
                ...
                <tr class="<?php echo $i % 2 === 0 ? 'odd' : 'even'; ?>">
                    <td><?php echo $tpl['expired'][$i]['ID']; ?></td>
                    <td><?php echo $tpl['expired'][$i]['F_Name']; ?></td>
                    <td><?php echo $tpl['expired'][$i]['Sp_FName']; ?></td>
                    <td><?php echo $tpl['expired'][$i]['Category']; ?></td>
                    <td><?php echo $tpl['expired'][$i]['Tele1']; ?></td>
                    <td><?php echo $tpl['expired'][$i]['email']; ?></td>
                    <td><a class="btn btn-success btn-sm" href="<?php echo INSTALL_URL; ?>Member/edit/<?php echo $tpl['expired'][$i]['ID']; ?>" rev="<?php echo $tpl['expired'][$i]['ID']; ?>"><span class="glyphicon glyphicon-pencil"></span></a></td>
