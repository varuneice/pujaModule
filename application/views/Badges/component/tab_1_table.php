        ...
        if ($count > 0) {
            for ($i = 0; $i < $count; $i++) {
                ...
                <tr class="<?php echo $i % 2 === 0 ? 'odd' : 'even'; ?>">
                    ...
                    <td><?php echo $tpl['active'][$i]['F_Name']; ?></td>
                    <td><?php echo $tpl['active'][$i]['Sp_FName']; ?></td>
                    <td><?php echo $tpl['active'][$i]['Category']; ?></td>
                    <td><?php echo $tpl['active'][$i]['Tele1']; ?></td>
                    <td><?php echo $tpl['active'][$i]['email']; ?></td>
                    <td><a class="btn btn-success btn-sm" href="<?php echo INSTALL_URL; ?>Member/edit/<?php echo $tpl['active'][$i]['ID']; ?>" rev="<?php echo $v['ID']; ?>"><span class="glyphicon glyphicon-pencil"></span></a></td>
