                ...
                <fieldset class="asb">
                    <table  class="table"> 
                        ...
                        <tr class="tr">
                            ...
                            <td class="td">
                                <input  id="phone_No" class="form-control input-sm" type="number" name="Mob_No"  value="" title="phone_No" placeholder="phone_No">
                            </td>
                            <td class="td">
                        ...
                        <tr class="tr">
                            ...
                            <td class="td">
                                ...
                                <input id="year_birth" class="form-control input-sm" type="date" name="Age1" size="25" value="" title="year_birth" placeholder="">
                            </td>   
                            <td class="td">
                            ...
                            <td class="td">
                                <label class="control-label" for="year_birth">Year of Birth</label>&nbsp;&nbsp;&nbsp;
                                <input id="year_birth" class="form-control input-sm" type="date" name="Age2" size="25" value="" title="year_birth" placeholder="">
                            </td>                       
                        </tr>
                        <tr class="tr">
                            <td  class="td">
                            ...
                            <td  class="td">
                                <label class="control-label" for="year_birth">Year of Birth</label>&nbsp;&nbsp;&nbsp;
                                <input id="year_birth" class="form-control input-sm" type="date" name="Age3" size="25" value="" title="year_birth" placeholder="">
                            </td>   
                            <td  class="td">
                            ...
                            <td  class="td">
                                <label class="control-label" for="year_birth">Year of Birth</label>&nbsp;&nbsp;&nbsp;
                                <input id="year_birth" class="form-control input-sm" type="date" name="Age4" size="25" value="" title="year_birth" placeholder="">
                            </td>                       
                        </tr>
                        <tr class="tr">
                        ...
                        <tr class="tr">
                            <td colspan="2" class="td"><label class="control-label" style="float:left;"for="Child">Category</label></td>
                           
                            <td class="td"> <label class="control-label" style="float:left;" for="Child">Rate </label></td>
                            <td class="td"><label class="control-label" style="float:left;" for="Child"> Paid</label> </td>                        
                        </tr>
                        <tr class="tr">
