            ...
            <fieldset>
                <table class="table"> 
                    <tr class="tr">
                        ...
                        <td class="td">
  <input required="" id="Member_id" class="form-control input-sm" type="text" name="Member_id" size="12" value="<?php echo ($tpl['arr'] ?? [])['Member_id'] ?? ''; ?>" title="MemberID" placeholder="MemberID">
  </td>
  <td class="td">Date of Renewal<span style="color:#ff0000"></span></td>
                        <td class="td">
  <input required="" id="Renew_date" class="form-control input-sm" type="text" name="Renew_date" size="12" value="<?php echo ($tpl['arr'] ?? [])['Renew_date'] ?? ''; ?>" title="Renew Date" placeholder="Renew Date">
  </td>
                    </tr>
</table>
                    <table class="table"> 
                    ...
                    <tr class="tr">
                        ...
                        <td class="td">
                            <input required=""  id="email" class="form-control input-sm" type="text" name="email" size="25" value="<?php echo ($tpl['arr'] ?? [])['email'] ?? ''; ?>" title="email" placeholder="Email">
                        </td>   
                        <td class="td">
                           Email 2
                        </td>
                    ...
                    <tr class="tr">
                        ...
                        <td class="td">Year of Birth<input id="year_birth" class="form-control input-sm date-picker"  name="Age1" size="25" value="<?php echo ($tpl['arr'] ?? [])['Age1'] ?? ''; ?>" title="year_birth" placeholder=""></td>   
                        <td class="td">Child 2<input id="Child" class="form-control input-sm" type="text" name="Child2" size="25" value="<?php echo ($tpl['arr'] ?? [])['Child2'] ?? ''; ?>" title="Child" placeholder="Child 2"></td>
                        <td class="td">Year of Birth<input id="year_birth" class="form-control input-sm date-picker"  name="Age2" size="25" value="<?php echo ($tpl['arr'] ?? [])['Age2'] ?? ''; ?>" title="year_birth" placeholder="">
                        </td>                       
                    </tr>
                    <tr class="tr">
                        <td  colspan="4" class="td">Child 3<input id="Child" class="form-control input-sm" type="text" name="Child3" size="25" value="<?php echo ($tpl['arr'] ?? [])['Child3'] ?? ''; ?>" title="Child" placeholder="Child 3"></td>
                        <td  class="td">Year of Birth<input id="year_birth" class="form-control input-sm date-picker"  name="Child" size="25" value="<?php echo ($tpl['arr'] ?? [])['Age3'] ?? ''; ?>" title="year_birth" placeholder=""></td>   
                        <td  class="td">Child 4<input id="Child" class="form-control input-sm" type="text" name="Child4" size="25" value="<?php echo ($tpl['arr'] ?? [])['Child4'] ?? ''; ?>" title="Child" placeholder="Child 4"></td>
                        <td  class="td">Year of Birth<input id="year_birth" class="form-control input-sm date-picker"  name="Age4" size="25" value="<?php echo ($tpl['arr'] ?? [])['Age4'] ?? ''; ?>" title="year_birth" placeholder=""></td>                       
                    </tr>
                    </table>
                            <table  class="table"> 
                    <tr class="tr">
                    ...
                    <tr class="tr">
                        <td colspan="2" class="td"><label class="control-label" for="Child">Category<span style="color:#ff0000">*</span></label></td>
                        <td  class="td"> <label class="control-label" for="Child">Rate<span style="color:#ff0000">*</span> </label></td>
                    ...
                    <tr class="tr">
                            ...
                            <td  > 
                                 ...
                                 <td  class="td">Date of Application</td>
                                 <td>
