...
.page-title .breadcrumb-column h4 { position: relative; font-family: "Open Sans",Arial,Helvetica,Sans-Serif;
    font-size: 16px; font-weight: 600; margin-bottom: 20px;
    color: #ffffff; letter-spacing: .5px ; padding-right: 10px;
    text-transform: capitalize;text-align: right; border-right: 3px solid #ff5252;
}
...
input.MIDtext3 {padding: 12px; font-size: 20px; margin-top: 20px; border-radius: 10px; width: 100%;}
...
.col-sm-4 input.MIDtext2 { width: 238px; }
.city { width: 33%;}
.state { width: 33%;}
.zip{ width: 33%;}
...
input#total { width: 355px; }
input#phone { width: 355px;}
input#zip_code { width: 224px;}
}
...
input#phone { width: 368px;}
input#memphone2fam { width: 368px;}
}
                       ...
                       if ($paymentmethod == 'stripe') {
                        ...
                        ?>
                                 <table border="4" width='585px' >
                                            ...
                                            <td colspan='2'> <img src='https://durgabari.org/HDBS_Puja_Payments/thankyouscreen.jpg' alt='' height='167px' style="margin-left:12em;"><h1 style="text-align:center;font-family:fangsong; font-size:30px;"><b>Houston Durga Bari Society</b></h1> </td> 
 ...
 <?php if ($dataregister != 'true' && $_SESSION['ytdvalue'] >= 9600 && $pujaregistered == 'true' && $sponsoreventfirst == 'true' && $sponsoreventsecond != 'true') {
                       ...
                       ?>
                                    ...
                                    <?php if (!$this->controller->isAdmin() && !$this->controller->isEditor()) { ?>
                                        <a href='https://durgabari.org/HDBS_Puja_Payments/PujaDonations/pujadonation'>Go to home</a>
                        <?php } ?>
                        <?php if ($this->controller->isAdmin() || $this->controller->isEditor()) { ?>
                            <a href='https://durgabari.org/HDBS_Puja_Payments/donationdata/index'>Go to home</a>
                         <?php } ?> 
                                <?php
                    } else {
                        ?>
        ...
        <div class="auto-container">
            <div class="row clearfix">
                ...
                <div class="breadcrumb-column col-lg-6 col-md-12 col-sm-12">
                    ...
                    <h3>HDBS 2023-24 Puja Online System</h3> 
    ...
    <div class="text_placeholders">Street No. *</div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4" style="display:none;">
                                     <input type="text"class="MIDtext2readonly" name="purpose" value="Puja Donation" selectBoxOptions="General;" tabindex="4" readonly>
    ...
    <div id="stripe_secret_key_id" style="display: none"><?php echo $tpl['option_arr_values']['stripe_publish_key']; ?></div>
         ...
         <div class="sidebar-side col-lg-4 col-md-12 col-sm-12">
             <aside class="sidebar">
                  ...
                  <?php if ($this->controller->isAdmin() || $this->controller->isEditor()) { ?>
                    <a style="font-size: 24px; text-decoration: none;color:#000; font-weight:600;" href="https://durgabari.org/HDBS_Puja_Payments/donationdata/index">Go Back to Dashboard</a>
                    <br><br>
                     <?php } ?>
                    ...
                    <div class="widget-content">
                       <div class="text">1. All donations to HDBS during the calendar year are counted towards sponsorship designation</div>
                       <div class="text">2. Registration is mandatory to avail Sponsorship privileges. Diamond sponsors can optionally include the registration fee within the sponsorship amount or do a separate registration. </div>
                       <div class="text">3. Emerald and Diamond sponsors are eligible for a free Puja Sankalpa</div>
                       <div class="text">4. Diamond sponsors can sponsor key Puja events: </div>
                       ...
                       <div class="text">5. The event sponsors will by recognized prominently on a range of media (digital screen, magazine, public address system)</div>
                       <div class="text">6. Free Puja Sankalpa for Emerald+ and event sponsorship for Diamond sponsors can be selected online after the payment is complete</div>
      ...
      function amountvalid() {
                                    ...
                                    if (isNaN(ytd)) {
                                        ...
                                        $('#sponsorcheck').hide();
                                            ...
                                            //$('#ytdmess').html("On completion of your payment puja registration is must, you will be assigned Jain Temple Parking.");
                                            ...
                                            $('#ytdmess').html("On completion of your payment puja registration is must, you will be assigned  Kala Bhavan Parking, contingent on Puja registration (All 3 Pujas / Durga Puja).");
                                            $('#msgdiv').show();
                                            $('#sponsorcheck').hide();
                                        }
                                        ...
                                        else if (price > 4599 && price <= 4999) {
                                            $('#ytdmess').html("On completion of your payment, you will be assigned Main Parking, contingent on Puja registration (All 3 Pujas / Durga Puja).");
                                            $('#msgdiv').show();
                                            $('#sponsorcheck').hide();
                                        } else if (price > 4999) {
                                        ...
                                        else if (newytd >4599 && newytd < 4999) {
                                            $('#ytdmess').html("On completion of your payment, you will be assigned Main Parking, contingent on Puja registration (All 3 Pujas / Durga Puja)");
                                            $('#msgdiv').show();
                                            $('#sponsorcheck').hide();
                                        }
...
function nextscreen(){
    ...
    var donationcategory = <?php echo json_encode($categorydata); ?>;
    var  registrationdata = "donationpagedata";
    var member_idpay = <?php echo (json_encode($memberid)); ?>;
    var paydate = <?php echo (json_encode($paydate)); ?>;
    var finaldonationid = <?php echo (json_encode($donationid)); ?>;
