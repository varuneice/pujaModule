                ...
                if (!empty($_SESSION['status'])) {
                       ...
                       if ($paymentmethod == 'stripe') {
                        ...
                        ?>
                                 <table border="4" width='585px' >
                                            ...
                                            <td colspan='2'> <img src='<?php echo INSTALL_URL; ?>thankyouscreen.jpg' alt='' height='167px' style="margin-left:12em;"><h1 style="text-align:center;font-family:fangsong; font-size:30px;"><b>Houston Durga Bari Society</b></h1> </td> 
                                
                                        </tr>
                                            <tr>
                                             <tr><td style="width:50%;">Order ID</td> <td style="width:50%;"><?php echo ($tpl['arr'] ?? [])['oid'] ?? ''; ?></td></tr>
                                              <tr><td>Member Id</td> 
                                            ...
                                            <tr><td>Payment Method</td> <td><?php echo $paymentdata; ?></td></tr> 
                                            <tr><td>Purpose</td> <td><?php echo ($tpl['arr'] ?? [])['purpose'] ?? ''; ?></td></tr>
                                            <tr><td>New Ytd</td> <td><span style="color:red;">$</span><?php echo $_SESSION['ytdvalue']; ?></td></tr>
                                            ...
                                            <?php if ($dataregister == 'true' && $pujaDonationTierIs($_SESSION['ytdvalue'], 'silver')) {
                    ...
                    ";
                     ...
                     <!-- second time show puja option condition total work Start -->
                               <?php if ($dataregister == 'true' && $_SESSION['ytdvalue'] >= $pujaDonationDiamondMin && $_SESSION['ytdvalue'] < $pujaDonationDoubleDiamondMin && $pujaregistered != 'true' && $sponsoreventfirst != 'true' && $pujaregisteredfirstattempt != 'true' && $pujaregisteredsecondattempt != 'true') {
                                                  echo "
                   ...
                   <?php if ($dataregister == 'true' && $_SESSION['ytdvalue'] >= $pujaDonationDiamondMin && $_SESSION['ytdvalue'] < $pujaDonationDoubleDiamondMin && $pujaregistered != 'true' && $sponsoreventfirst == 'true' && $pujaregisteredfirstattempt != 'true' && $pujaregisteredsecondattempt != 'true' ) {
                    ...
                    <tr id='submitbuttontr'><td colspan='2'><button id='requestsubmit' class='btn btn-primary'   type='submit' onclick='nextscreen()'><i class='fa fa-fw fa-save'></i>&nbsp;&nbsp;Submit</button></td></tr>";
                                           ...
                                           <!-- update condition new 20 july  -->
                                              <?php if ($dataregister == 'true' && $_SESSION['ytdvalue'] >= $pujaDonationDiamondMin && $_SESSION['ytdvalue'] < $pujaDonationDoubleDiamondMin && ($pujaregistered != 'true' || $pujaregistered == 'true') && $sponsoreventfirst != 'true' && $pujaregisteredfirstattempt == 'true' && $pujaregisteredsecondattempt != 'true') {
                                                  echo "
...
<?php if ($dataregister == 'true' && $_SESSION['ytdvalue'] >= $pujaDonationDiamondMin && $_SESSION['ytdvalue'] < $pujaDonationDoubleDiamondMin && $pujaregistered == 'true' && $sponsoreventfirst != 'true' && $pujaregisteredfirstattempt == 'true' && $pujaregisteredsecondattempt == 'true') {
                   echo " <tr id='eligiblemsg' style='color:red;'><td colspan='2'><span style='text-transform: uppercase; font-weight: bold;color:red;'>You are eligible for: Event Sponsorship</span> Select 1 from the option below.</td></tr>
                    ...
                    <tr id='submitbuttontr'><td colspan='2'><button id='requestsubmit' class='btn btn-primary'  type='submit' onclick='nextscreen()'><i class='fa fa-fw fa-save'></i>&nbsp;&nbsp;Submit</button></td></tr>";
                                             ...
                                             <?php if ($dataregister == 'true' && $_SESSION['ytdvalue'] >= $pujaDonationDoubleDiamondMin && $pujaregistered != 'true' && $sponsoreventfirst != 'true' && $sponsoreventsecond != 'true') {
                                                 echo "
                                <tr class='tr' id='sankalpapujamsgprice'>
                                <td class='td' span style='text-transform: uppercase; font-weight: bold;color:red;'>You are eligible for one free puja sankalpa</td>
                               <td class='td'><select  name='' id='pujasankalp' 
                         ...
                         <td class='td'>Category B</td>
                            ...
                            "
                                ...
                                ";
                                             ...
                                             ?>
            <?php if ($dataregister == 'true' && $_SESSION['ytdvalue'] >= $pujaDonationDoubleDiamondMin && $pujaregistered == 'ture' && $sponsoreventfirst != 'true' && $sponsoreventsecond != 'true') {
                echo "
                       <tr id='eligiblemsg'><td colspan='2' style='color:red;'><span style='text-transform: uppercase; font-weight: bold;color:red;'>You are eligible for: Event Sponsorship</span>(Select 2 from Category A or 1 from Category B).</td></tr>
                       <tr class=tr' id='optiondropdown'>
                       <td class='td'>Category A</td>
 ...
 <?php if ($dataregister == 'true' && $_SESSION['ytdvalue'] >= $pujaDonationDoubleDiamondMin && $pujaregistered == 'true' && $sponsoreventfirst == 'true' && $sponsoreventsecond != 'true') {
                       ...
                       ?>
                                             ...
                                             <?php if ($dataregister != 'true' && $pujaDonationTierIs($_SESSION['ytdvalue'], 'silver') && $membertype != 'PM' && $membertype != 'FP') {
                                                 echo "<tr><td>Parking Area</td> <td style='color:red;' >You will be assigned Green Field parking option at a discounted rate</td></tr>";
                                             }
                                             ?>
                                            <?php if ($dataregister != 'true' && $pujaDonationTierIs($_SESSION['ytdvalue'], 'gold') && $membertype != 'PM' && $membertype != 'FP') {
 ...
 <?php if ($dataregister != 'true' && $_SESSION['ytdvalue'] >= $pujaDonationDoubleDiamondMin && $pujaregistered == 'true' && $sponsoreventfirst == 'true' && $sponsoreventsecond != 'true') {
                    ...
                    <form id="donation-frm-id" class="form-horizontal" method="post" action="" role="form">
                        ...
                        <fieldset class="asb">
                            ...
                            <div class="row">
                                ...
                                <select required="" name="regmember" id="registrationmember" class="choice" aria-required="true" aria-invalid="false" tabindex="1">
                              <!-- <option value="">Please select Member type</option>   -->
                                ...
                                <div id="otp-gate" class="col-lg-12 col-md-12 col-sm-12" style="display:none;margin-top:8px;">
                                ...
                                <div id="IDMembertd" class="col-lg-12 col-md-12 col-sm-12 disabledbutton">
                                     <input type="text" name="term" id="term" placeholder="search records here.... *"  class="MIDtext3" tabindex="2" required>
                             ...
                             <!--   </div>-->
                                 ...
                                 <input type="text" style="display:none" name="termMember" id="termMember"  placeholder="search member here...." class="MIDtext2 form-control">
                                
                        <div class="col-lg-6 col-md-6 col-sm-6" id="memberiddiv">
                             <input type="text" name='demmember' id="demmember" class="MIDtext2 point" oninvalid="InvalidMsg(this);" oninput="InvalidMsg(this);"  >  
                            ...
                            <!--    </div>-->
                                <!--  puja donation -->
                                 ...
                                 <div class="col-lg-6 col-md-6 col-sm-6" id="membercategorydiv">
                                    <input id="MembCategory" class="MIDtext2readonly" type="text" placeholder="Membership Category"  name="membercategory" tabindex="14" readonly> 
                                 ...
                                 <input type="text" name='fisrtname' id="First_name" placeholder="First Name" class="MIDtext2" required>  
                                  <div class="text_placeholders">First Name *</div>        
                                 </div>


                                 <div class="col-lg-6 col-md-4 col-sm-6" id="lnamediv">
                                 <input type="text" name='lastname' id="last_name" placeholder="Last Name*" class="MIDtext2" required>  
                                  <div class="text_placeholders">Last Name *</div>        
                                 </div>

                                 <div class="col-lg-6 col-md-4 col-sm-6" id="spfnamediv">
                                 <input type="text" name='spfname' id="spouseFirst_name" placeholder="Spouse First Name" class="MIDtext2" >  
                                  <div class="text_placeholders">Spouse First Name </div>        
                                 </div>


                                 <div class="col-lg-6 col-md-4 col-sm-6" id="splnamediv">
                                 <input type="text" name='splname' id="spouselast_name" placeholder="Spouse Last Name" class="MIDtext2" >  
                                  <div class="text_placeholders">Spouse Last Name </div>        
                                 </div>
                                
                                 <div class="col-lg-6 col-md-6 col-sm-6" id="streetdiv">
                                    <input  id="Street" class="MIDtext2" type="text" placeholder="Street No. *" value="" name="Street" tabindex="5" required="">
    <div class="text_placeholders">Street No. *</div>
                                </div>
                                
                                 <div class="col-lg-6 col-md-6 col-sm-6" id="streetnamediv">
                                      <input  id="ressidentalAddress" class="MIDtext2" type="text" placeholder="Street Name *" value="" name="Address" tabindex="6" required="">
                                   <div class="text_placeholders">Street Name *</div>
                                </div>
                                
                                 <div class="col-lg-4 col-md-4 col-sm-4" id="citydiv">
                                     <input  id="city" class="MIDtext2" type="text" name="City" size="25" value="" placeholder="City *" tabindex="7" required="">
                                    <div class="text_placeholders">City *</div>
                                </div>
                                
                                 <div class="col-lg-4 col-md-4 col-sm-4" id="statediv">
                                     <input  id="state" class="MIDtext2" type="text" name="State" size="25" value="" placeholder="State *" tabindex="7" required="">
                                     <div class="text_placeholders">State *</div>
                                </div>
                                 <div class="col-lg-4 col-md-4 col-sm-4" id="zipdiv"> 
                                    <input id="zip_code" class="MIDtext2" type="text" placeholder="Zip Code *" value="" name="Zip_Code" tabindex="9" required="">
                                   <div class="text_placeholders">Zip Code *</div>
                                </div>
                                
                                 <div class="col-lg-6 col-md-6 col-sm-6 phone" id="phonenodiv">
                                      <input id="phone" class="MIDtext2readonly" type="text" required="" placeholder="##########" value="" name="Tele1"  onchange="sponsoramount(this.id)" maxlength="10" tabindex="11"> 
                                ...
                                <div class="text_placeholders">Mobile Number *</div>
                                 ...
                                 <div class="col-lg-6 col-md-6 col-sm-6" id="emaildiv">
                                     <input required="" id="email" class="MIDtext2readonly" type="text" placeholder="name@company.com" value="" name="email" tabindex="11" pattern="[^@\s]+@[^@\s]+\.[^@\s]+">
                                   <div class="text_placeholders">Email *</div>
                                </div>
                                
                                  <div class="col-lg-6 col-md-6 col-sm-6" id="alternateemaildiv">
                                     <input id="email2" class="MIDtext2" type="text" placeholder="name@company.com" value="" name="alternateemail" tabindex="11" pattern="[^@\s]+@[^@\s]+\.[^@\s]+">
                                   <div class="text_placeholders">Alternate Email</div>
                                </div>
                                
                                 <div class="col-lg-6 col-md-6 col-sm-6" id="lifetimediv">
                                    <input id="ltd1" class="MIDtext2readonly" type="text" placeholder="Lifetime Contribution" value="" name="LTC" tabindex="12" readonly>
                                  <div class="text_placeholders">Lifetime Contribution</div>
                                </div>
                                
                                 <div class="col-lg-6 col-md-6 col-sm-6" id="ytddiv">
                                     <input id="ytd1" class="MIDtext2readonly" type="text" placeholder="Annual Donation"  value="" name="YTD" tabindex="13" readonly>
                                   <div class="text_placeholders">Annual Donation</div>
                                </div>
                                
                                 <div class="col-lg-6 col-md-6 col-sm-6" id="amountdiv">
                                  <input required id="total" class="MIDtext2" type="number" placeholder="( $ ) Donation Amount *" value="" name="Amount" tabindex="15" onchange="amountvalid(this.id)" pattern="[0-9]">
                                   <div class="text_placeholders">($) Donation Amount *</div>
                                </div>
                                
                                 <div class="col-lg-6 col-md-6 col-sm-6" id="futureytddiv">
                                <input name="newytdfeature" id="futureytd" class="MIDtext2readonly" type="text" placeholder="( $ ) Your future YTD" value="" style="width:100%;  height:50%;" tabindex="16" readonly>
    ...
    <tr class="tr" style="display:none;" id="sponsorcheck">
                            <td class="td" colspan="2">
                                <select  name="" id="sponser" onchange="ListCreate()" class="choice" aria-required="true" aria-invalid="false" >
                             <option value="">Please select</option> 
                             <option value="yes">Yes</option>
                                    <option value="no">No</option>
                                     </select>
                                     <div class="text_placeholders">Are you Interested in Sponsor Parking</div>
             ...
             <!-- The Modal -->
              <div id="myModal" class="modal">
                ...
                <div class="modal-content">
                  ...
                  <div class="popup_title"><b>Sponsorship Privileges (Information only, please go back to Donation field to adjust your donation)</b></div>
                  <table class="table table-bordered table-condensed table-hover table-striped text-center popup_table">
                  <tbody id="data" class="feature text-left popup_tbody">
                  <tr class="tr"> 
                            <td class="td" style="background-color:black;color:white;">Category</td>
                            <td class="td" style="background-color:black;color:white;">Sponsorship Amount</td>
                            <td class="td" style="background-color:black;color:white;">Parking Assigned</td>
                            <td class="td" style="background-color:black;color:white;">Additional</br>Donation Needed</td>
                        </tr>
                        <tr class="tr" id="diamondtr">
                            <td class="td" style="background-color:red;color:black;">Diamond</td>
                            <td class="td" id="diamond">$5000+( Registration optional)</td>
                            <td class="td" style="background-color: #f3f4f5;">Main Parking.<br> Named slots for $10K</td>
                       
                        </tr>
                        <!-- PUJA_DONATION_DIAMOND_RENDER_FIX_20260614 -->
                        <tr class="tr" id="emeraldtr">
                            <td class="td" style="background-color:#98FB98;color:black;">Emerald</td>
                            <td class="td" id="emerald" style="background-color:white;" >$2000+</td>
                            <td class="td" rowspan="2">Main or Kala Bhavan (KB)Parking<br>
                                          (in order of date of Sponsorship)</td>
                            

                        </tr>
                        <tr class="tr" id="platinumtr">
                            <td class="td" style="background-color:blue;color:white;">Platinum</td>
                            <td class="td" id="platinum">$1200 - $1999</td>
                            <!-- <td class="td"></td> -->
                     
                        </tr>
                        <tr class="tr" id="goldtr">
                            <td class="td" style="background-color:yellow;color:black;">Gold</td>
                            <td class="td" id="gold" style="background-color:white;">$800 - $1199</td>
                            <td class="td">Green Field<br>Prioritized upgrade to KB Parking if space available.<br> Kb Parking for CT Gold Sponsors.</td>
                       
                        </tr>

                        <tr class="tr" id="silvertr">
                            <td class="td" style="background-color:#E6E6FA;color:black;">Silver</td>
                            <td class="td" id="silver">$400 - $799</td>
                            <td class="td" style="background-color: #f3f4f5;">Jain Temple <br>(Subject to availability;Specified days only)</td>
                        </tr>
                  </tbody>
    ...
    <tr style="display:none;"> <td class="td"  style="display:none;"> <input id="Your_Name" class="form-control input-sm" type="test" name="MemberName"  style="display:none;"> </td></tr>
    ...
    <div id="otp-session-verified" style="display:none"><?= htmlspecialchars((string) ($otpVerifiedMember ?? ''), ENT_QUOTES) ?></div>
    <table class="table" id="paydropdiv">
                        <tr class="tr">
                            <td class="td" colspan="2">
                            <?php if ($this->controller->isAdmin() || $this->controller->isEditor()) { ?>
                            <select name="PaymentOption" style="width:100%;  height:50%;" id="PaymentOption" class="choice form-control input-sm  valid"
                            required>
                            <option value="">Please Select</option>
                        ...
                        <?php } ?> 
                        <?php if (!$this->controller->isAdmin() && !$this->controller->isEditor()) { ?>
                            <select required="" name="PaymentOption" id="PaymentOption" class="choice form-control input-sm  valid" aria-required="true" aria-invalid="false" style="width:100%;  height:50%;" tabindex="17">
                                                        ...
                                                        <tr class="tr" id="MemberID1" style="display: none;"
                                                            ...
                                                            <td style="display: block;">
                                                                ...
                                                                <div id="zelle-action-btns" style="display:none;margin-top:8px;">
                                                                    ...
                                                                    <button type="button" id="zelle-retry-btn" class="btn btn-default btn-sm" style="margin-left:8px;">Search Again</button>
                                                                </div>
                                                                <div id="zelle-manual-fields" style="display:none;margin-top:10px;">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label style="font-size:13px;">Zelle payment date:</label>
                        ...
                        <div id="zelle-modal-overlay" style="display:none;position:fixed;inset:0;background:rgba(0,0,0,0.6);z-index:9100;justify-content:center;align-items:center;">
                            <div style="background:#fff;border-radius:8px;width:660px;max-width:96vw;max-height:90vh;overflow-y:auto;box-shadow:0 8px 32px rgba(0,0,0,0.25);position:relative;font-family:Arial,sans-serif;">
                                ...
                                <div style="padding:18px 24px 16px;font-size:14px;color:#333;line-height:1.8;">
                                    ...
                                    <b>Step 2</b> - Send your donation amount to <b>treasurerpuja@durgabari.org</b>.<br>
    ...
    <tbody>
        <tr class="tr">
            ...
            <td class="td"><input style="WIDTH: 100%;" type="date" id="date" name="transactiondate"
                    class="form-control input-sm" value=""></td>
                      <td class="td"><select name="DirectPayDepositAccount" class="choice">
                                                                    <option value="PujaAccount">Puja Account</option>
                                                                    <option value="RegularAccount">Regular Account</option>
                                                                </select>
                                                            </td>
    ...
    <tbody>
        <tr class="tr">
            <td class="td"><input style="WIDTH: 100%;" type="text" id="sumdata" name="sumupid"
                    ...
                    class="form-control input-sm" value=""></td>
                    <td class="td"><select name="SumUpDepositAccount" class="choice">
                                                                    <option value="PujaAccount">Puja Account</option>
                                                                    <option value="RegularAccount">Regular Account</option>
                                                                </select>
                                                            </td>
                                ...
                                <div class="row" id="submitdatadiv">
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <button id="reset-btn-id" class="go_cart_btn btn" autocomplete="off" value="Save" name="Reset" tabindex="16" type="submit"><i class="fa fa-fw fa-save"></i>&nbsp;&nbsp;Reset</button>
                                    </div>
                                    
                                     <div class="col-lg-6 col-md-6 col-sm-6">
                                        <button id="payment_btn_id" class="go_cart_btn btn" autocomplete="off" value="Save" name="Payment" tabindex="17" type="submit"><i class="fa fa-fw fa-save"></i>&nbsp;&nbsp;Make Payment</button>
                                    </div>
        ...
        <?php require __DIR__ . '/../components/otp_modal.php'; ?>
         ...
         <div class="sidebar-side col-lg-4 col-md-12 col-sm-12">
             <aside class="sidebar">
                  ...
                  <?php if ($this->controller->isAdmin() || $this->controller->isEditor()) { ?>
                    <a style="font-size: 24px; text-decoration: none;color:#000; font-weight:600;" href="<?php echo INSTALL_URL; ?>donationdata/index">Go Back to Dashboard</a>
                    <br><br>
                     <?php } ?>
                    ...
                    <div class="widget-content">
                                ...
                                <div class="text">a. Diamond sponsors with $5-10K contribution may select one event from Category A</div>
                                <div class="text">b. Diamond sponsors with >$10K contribution may select two events from Category A or one from Category B</div>
                                <div class="text">3. Sponsorship privileges include onsite parking (free or discounted based on sponsorship category). <a href="<?php echo INSTALL_URL; ?>Sponsorship/Sponsorship">Click here for a full description of sponsorship privileges</a> </div>
                                <div class="text">4. Registration is mandatory to avail Sponsorship privileges. Diamond sponsors can optionally include the registration fee within the sponsorship amount or do a separate registration. </div>
                                <div class="text">5. All donations to HDBS during the calendar year are counted towards sponsorship designation</div>
                                <div class="text">6. Emerald and Diamond sponsors are eligible for a free Puja Sankalpa</div>
                                <div class="text">7. The event sponsors will by recognized prominently on a range of media (digital screen, magazine, public address system)</div>
                                <div class="text">8. Free Puja Sankalpa for Emerald+ and event sponsorship for Diamond sponsors can be selected online after the payment is complete</div>
                    </div>
                </div>
...
function sponsoramount(elem){
    ...
    const phonenumber =  $("#phone").val();
      ...
      function amountvalid() {
        ...
        if (donationYtdTierIs(futureYtd, ['base 1', 'base 2'])) {
            $('#ytdmess').html('');
            $('#msgdiv').hide();
            $('#sponsorcheck').show();
        } else if (donationYtdTierIs(futureYtd, 'silver') && isPreferredMember) {
            $('#ytdmess').html("On completion of your payment, you will be assigned parking at Kala Bhavan, contingent on Puja Registration (All 3 Pujas/ Durga Puja).");
            $('#msgdiv').show();
            $('#sponsorcheck').hide();
        } else if (donationYtdTierIs(futureYtd, 'silver')) {
            $('#ytdmess').html("On completion of your payment, you will have the option for parking at Green Field at a discounted rate, contingent on Puja registration (All 3 Pujas / Durga Puja). Visit Associated Payments/Paid Parking after your Registration");
            $('#msgdiv').show();
            $('#sponsorcheck').hide();
        } else if (donationYtdTierIs(futureYtd, 'gold') && isPreferredMember) {
            $('#ytdmess').html("On completion of your payment, you will be assigned Kala Bhavan Parking, contingent on Puja registration (All 3 Pujas / Durga Puja).");
            $('#msgdiv').show();
            $('#sponsorcheck').hide();
            ...
            $('#msgdiv').show();
            $('#sponsorcheck').hide();
        } else if (donationYtdTierIs(futureYtd, ['platinum', 'emerald'])) {
            ...
            $('#msgdiv').show();
            $('#sponsorcheck').hide();
        } else if (donationYtdTierIs(futureYtd, 'diamond')) {
