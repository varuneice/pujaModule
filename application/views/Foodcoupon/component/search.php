        ...
        <row class="row">
            ...
            <!-- <div class="col-sm-4">
                <div class="form-group">
                    ...
                    <input id="Member_id" class="form-control input-sm" type="number" name="Member_id" size="25" value="<?php echo h($_POST['Member_id'] ?? ''); ?>" title="<?php echo __('member Id'); ?>" placeholder="">
                </div>
            </div> -->
            <div class="col-sm-4">
                <div class="form-group">
                    <label class="control-label" for="second_name"><?php echo __('category'); ?>:</label>
                    <input id="second_name" class="form-control input-sm" type="text" name="Category" size="25" value="<?php echo h($_POST['Sp_FName'] ?? ''); ?>" title="<?php echo __('category'); ?>" placeholder="">
                </div>
            </div>
            <div class="col-sm-4">
                <div class="form-group">
