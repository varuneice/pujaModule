<head>
            ...
            <div class="row clearfix">
                ...
                <div class="breadcrumb-column col-lg-6 col-md-12 col-sm-12">
                    ...
                    <ul class="bread-crumb clearfix">
                        ...
                        <li class="active">Mail in Option</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 text-center">
                <!-- <img src="../mail_in.svg" alt="Mail in Option" width="100%"> -->
                <img src="../mailFlyer.jpg" alt="Mail in Option" width="100%">
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 text-center">
                <!-- <a href="../2023 Regular Puja Registration Form.pdf" class="a_go_cart_btn" target="_blank">Download</a>  -->
                <a href="../pujaform.pdf" class="a_go_cart_btn" target="_blank">Download</a>
            </div>
        </div>
