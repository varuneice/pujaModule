...
.clear { clear: both; }
.close { text-align: right !important; padding-right: 10px; ont-size: 40px; color: red; opacity: .8; }
...
#submitbutton { padding: 10px; font-size: 22px; border-radius: 10px; width: 100%; background-color: #000; color: #fff; margin-top: 30px; font-weight: 600; }
...
<div class="col-lg-8 col-md-12 col-sm-12">
            ...
            <div style="border-left: 3px solid #ef260f;border-right: 3px solid #ef260f;border-bottom: 3px solid #ef260f;" id="showRegistration" class="myChoice">
                <div class="clear"></div>
                    ...
                    <div id="showMember" class="myDiv" style="display:block;">
                        ...
                        <div class="row">
                            <div id="hide_nm" class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <input class="MIDtext2" type="text" name="term" id="term" placeholder="Search your records *" tabindex="2" required>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <input class="MIDtext2readonly" style="width:100%;" type="text" name="puja_type" id="selectedpujatype" placeholder="Puja Type *" required/>
                                <div class="text_placeholders">Puja Type *</div>
                            </div>

                            <div class="text_placeholders" id="notregistermsg" style="display:none;font-size:17px;font-weight: bold;"></div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <input class="MIDtext2readonly" style="width:100%;" type="text" name="First_name" id="memfnamefam" placeholder="First Name *" required/>
                                <div class="text_placeholders">First Name *</div>
                            </div>

                            <div class="col-md-6">
                                <input class="MIDtext2readonly" style="width:100%;" type="text" name="Last_name" id="memlnamefam" placeholder="Last Name *" required/>
                                <div class="text_placeholders">Last Name *</div>
                            </div>

                            <div class="col-md-6">
                                <input class="MIDtext2" style="width:100%;" type="text" name="Sp_fname" id="memspfnamefam" placeholder="Spouse First Name"/>
                                <div class="text_placeholders">Spouse First Name</div>
                            </div>

                            <div class="col-md-6">
                                <input class="MIDtext2" style="width:100%;" type="text" name="Sp_lname" id="memsplnamefam" placeholder="Spouse Last Name"/>
                        ...
                        <div class="row">
                            <div class="col-md-6 checkbox" style="display:none;">
                                <input style="visibility: visible;margin: 34px 0px 0px 4px;" class="checkbox" type="checkbox" id="senior" name="senior" value="1" onchange="parkingfielddata(this)">
                                <label for="senior">Check here, if Senior</label>
                            </div>

                              <div class="col-md-6 checkbox">
                                <input style="visibility: visible;margin: 34px 0px 0px 4px;" class="checkbox" type="checkbox" id="seniorseventyabove" name="seniorseventyplus" value="yes" onchange="parkingfielddata(this)">
                                <label for="senior">Check here, if Senior 70+</label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-3">
                        ...
                        <div class="row">
                            <div class="col-md-6 phone">
                                <input class="MIDtext2readonly" type="text" name="phone" id="memphonefam" placeholder="##########" maxlength="10" required/>
                                <div class="text_placeholders">Phone Number *</div>
                            </div>
                            <div class="col-md-6 phone">
                                <input class="MIDtext2" type="text" name="alternatenumber" id="memphone2fam" placeholder="##########" maxlength="10" required/>
                                <div class="text_placeholders">Mobile Number *</div>
                            </div>
                            <div class="col-md-6">
                                <input class="MIDtext2readonly" style="width:100%;" type="text"  required name="email" id="mememailfam" placeholder="name@company.com" pattern="[^@\s]+@[^@\s]+\.[^@\s]+" />
                        ...
                        <div class="row">
                            <div class="col-md-12">
                           <input class="MIDtext2readonly" type="text" name="ytddata" id="ytd" style="display:block;" placeholder="Annual YTD($)">
                           <div class="text_placeholders">YTD ($)</div>
                           </div>
                            <div class="col-md-6" style="display:none;margin-top: 16px;" id="parkingfielddiv">
                                <select class="choice" id="parkingfield" name="parking" required onchange="parkingprice(this)">
                                </select>
                                <div class="text_placeholders">Parking Field *</div>
                            </div>
                            
                             <div class="col-md-6">
                                <input class="MIDtext2readonly"  type="number" required name="amount" id="total_value4" readonly placeholder="Total Amount($) *" />
                       ...
                       <!-- hidden field for parking area  and ytd -->
                        ...
                        <tr class="tr">
                            ...
                            <select name="PaymentOption" style="width:100%;  height:50%;" onchange="paymentmethod(this.id)" id="PaymentOption" class="choice"
                            required>
...
<?php if ($this->controller->isAdmin() || $this->controller->isEditor()) { ?>
                    <a style="font-size: 24px; text-decoration: none;color:#000;" href="https://durgabari.org/HDBS_Puja_Payments/parkingadmin/index">Go Back to Dashboard</a>
                    <br><br>
                     <?php } ?>
                    ...
                    <div class="widget-content">
                        <div class="text"><strong>Step 1 : </strong>Express your interest to purchase a parking spot</div>
                        ...
                        <div class="text"><strong>1. </strong>Parking for Durga Puja and Kali Puja only. Open parking during Saraswati Puja.</div>
                        <div class="text"><strong>2. </strong>Prior Puja registration is mandatory. Please submit this after you have completed your registration.</div>
                        <div class="text"><strong>3. </strong>Due to limited space, Sponsors, Senior Registrants and Registrants with accompanying (registered) parents will be prioritized for Green Field parking. General Registrants will be held on a priority list and notified based on any remaining parking space availability. Reservation is final only after due payment processing and confirmation. </div>
                        <div class="text"><strong>4. </strong>Gold+ Sponsors will have assigned parking and are not required to submit this request. Silver Sponsors may opt for Green Field parking at a discounted rate thru this process</div>
                        <div class="text"><strong>5. </strong>Senior status/discount applies to primary registrant and spouse only (not to accompanying parents)</div>
                        <div class="text"><strong>6. </strong>Parking in Green Field is subject to weather and ground conditions. Payment will be refunded if the Green Field is not in a usable condition for at least two days out of Fri/Sat/Sun during Durga Puja</div>
                        </div>
                </div>
...
<script>
                ...
                success: function (res) {
                    ...
                    if (memberregcheckElement.length) {
                        ...
                        if (datamember == 'true') {
                            ...
                            $.ajax({
                                ...
                                //     document.getElementById("memtypefam").value = membershiptype;
                                    ...
                                    if (ytd1Element.length) {
                                        ...
                                        if (ytd1 > 799){
                                            $('#notregistermsg').html("You are eligible for Sponsor Parking. You do not need to use this site.<br><a href='https://durgabari.org/HDBS_Puja_Payments/Sponsorship/Sponsorship'>Click Here For Sponsor Parking</a>");
                                            $('#notregistermsg').show();
                            ...
                            $('#notregistermsg').html("You have not registered for Puja (All 3 Pujas or Durga Puja). Please complete your registration first.<br><a href='https://durgabari.org/HDBS_Puja_Payments/Sponsorship/Sponsorship'>Click Here For Puja Registration</a>");
                            $('#notregistermsg').show();
                            $("#submitbutton").addClass('disabled');
                            $("#memidfam").val("");
                            $("#memcatfam").val("");
    ...
    //     const parkingvalue = $("#parkingfield").val();
    //     var parkingname = $("#parkingfield option:selected").text();
    //     const parkingytd = parseInt($("#ytd").val());
    //     var seniorseventyplus = document.getElementById('seniorseventyabove');
    //     if (parkingvalue != "") {

    //         if(parkingytd >399 && parkingytd < 799 && seniorseventyplus.checked == true){
    //           priceafterdiscount =   parseInt(parkingvalue) - 100;
    //           $('#total_value4').val(priceafterdiscount);
    //           const discountmsg = "$ 100 Discount Applied";
...
window.onbeforeunload = function () {
 ...
 function paymentmethod() {
        ...
        var memfnamefam = $("#memfnamefam").val();
              ...
              if (!(total >= 1) || mememailfam == "" || memphone2fam == "" || memphonefam == "" || mamzipcodefam == "" || memstatefam == "" || memcityfam == "" || memstreetnamefam == "" || memstreetfam == "" || memlnamefam == "" || memfnamefam == ""){
