    ...
    <div class="box-body">
        ...
        <?php if ($tpl['option_arr_values']['first_name'] != 1) { ?>
            ...
            <div class="form-group">
                ...
                <input id="first_name" class="form-control input-sm" <?php echo ($tpl['option_arr_values']['first_name'] == 3) ? "data-rule-required='true'" : ""; ?> type="text" name="first_name" size="25" value="<?php echo h($_POST['first_name'] ?? ''); ?>" title="<?php echo __('first_name'); ?>" placeholder="First Name" style="font-weight: bold;transform: translateX(-25%);">
                <div class="control-group"></div>
            </div>
        <?php } ?>
        <?php if ($tpl['option_arr_values']['second_name'] != 1) { ?>
            <div class="form-group">
                ...
                <input id="second_name" class="form-control input-sm" <?php echo ($tpl['option_arr_values']['second_name'] == 3) ? "data-rule-required='true'" : ""; ?> type="text" name="second_name" size="25" value="<?php echo h($_POST['second_name'] ?? ''); ?>" title="<?php echo __('second_name'); ?>" placeholder="Last Name" style="font-weight: bold;transform: translateX(-25%);">
                <div class="control-group"></div>
            </div>
        <?php } ?>
        <?php if ($tpl['option_arr_values']['phone'] != 1) { ?>
            <div class="form-group">
                ...
                <input id="phone" class="form-control input-sm" <?php echo ($tpl['option_arr_values']['phone'] == 3) ? "data-rule-required='true'" : ""; ?> type="text" name="phone" size="25" value="<?php echo h($_POST['phone'] ?? ''); ?>" title="<?php echo __('phone'); ?>"pattern="[0-9]{3}[0-9]{3}[0-9]{4}" placeholder="Phone" style="font-weight: bold;transform: translateX(-25%);">
                <div class="control-group"></div>
            </div>
        <?php } ?>
        <?php if ($tpl['option_arr_values']['email'] != 1) { ?>
            <div class="form-group">
                ...
                <input id="email" class="form-control input-sm"  <?php echo ($tpl['option_arr_values']['email'] == 3) ? "data-rule-required='true'" : ""; ?> type="email" name="email" size="25" value="<?php echo h($_POST['email'] ?? ''); ?>" title="<?php echo __('email'); ?>" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" placeholder="Email" style="font-weight: bold;transform: translateX(-25%);">
                <div class="control-group"></div>
            </div>
        <?php } ?>
        ...
        <?php if ($tpl['option_arr_values']['address_1'] != 1) { ?>
            <div class="form-group">
                ...
                <input id="address_1" class="form-control input-sm" <?php echo ($tpl['option_arr_values']['address_1'] == 3) ? "data-rule-required='true'" : ""; ?> type="text" name="address_1" size="25" value="<?php echo h($_POST['address_1'] ?? ''); ?>" title="<?php echo __('address_1'); ?>" placeholder="Address" style="font-weight: bold;transform: translateX(-25%);">
                <div class="control-group"></div>
            </div>
        <?php } ?>
        ...
        if ($tpl['option_arr_values']['additional'] != 1) { ?>
            <div class="form-group">
                ...
                <textarea  style="font-weight: bold;transform: translateX(-25%);" placeholder="Additional Request" <?php echo ($tpl['option_arr_values']['additional'] == 3) ? "data-rule-required='true'" : ""; ?> name="additional" class="form-control" title="<?php echo __('additional'); ?>"><?php echo h($_POST['additional'] ?? ''); ?></textarea>
            </div>
            <?php
        }
        if ($tpl['option_arr_values']['enable_payment'] == 1) {
            ...
            <div id="MemberID1" style="display: none;" class="form-group">
                    ...
                    <select data-rule-required='true' id="MemberID" name="oid"  class="form-control input-sm" style="font-weight: bold;transform: translateX(-25%);">
                ...
                <button style="display: none;margin-top: 26px;" type="button" id="checkPaymentData" >Get Zelle Payment Details</button>
