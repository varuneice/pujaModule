  ...
  #gz-abc-calendar-container-1 > div > div:nth-child(1) > div > table > tbody > tr:nth-child(14) > td:nth-child(3)
{
    display:none!important;
                    ...
                    $count = (int)($count ?? 0);
                    if ($date <= 0 || empty($start_time) || empty($end_time) || $slot_lenght <= 0) {
                        return;
                    }
                                        ...
                                        if ($count > 1) {
                                            ...
                                            <select name="count" data-date="<?php echo $date; ?>" data-start-time="<?php echo $i; ?>" class="gzTimeSlotDropDownClass">
                                                ...
                                                for ($c = 1; $c <= ($count - $booked); $c++) {
                                                    ?>
                                                    <option <?php echo (!empty($_SESSION[$this->controller->default_product]['slots'][$cid][$i]) && $_SESSION[$this->controller->default_product]['slots'][$cid][$i] == $c) ? "selected='selected'" : ""; ?> value="<?php echo $c; ?>"><?php echo $c; ?></option>
                                                    <?php
                                                }
                                                ?>
                                            </select>
                                            ...
                                            if (empty($_SESSION[$this->controller->default_product]['slots'][$cid][$i])) {
                                                ?>
    ...
    <div class="box box-solid box-primary">
        <div class="box-body">
            ...
            <a data-style="expand-left" href="javascript:" class="btn btn-warning ladda-button <?php echo (!(count($_SESSION[$this->controller->default_product]['slots'][$cid] ?? []) > 0)) ? "disabled" : ""; ?>" id="booking_frm_btn_id" autocomplete="off" value="<?php echo __('booking'); ?>" name="submit" tabindex="9" type="submit">
