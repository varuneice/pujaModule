            ...
            for ($i = 0; $i < $count; $i++) {
                ...
                <tr class="<?php echo $i % 2 === 0 ? 'odd' : 'even'; ?>">
                   ...
                   <td><?php echo $tpl['arr'][$i]['State'] ; ?></td>
                    ...
                    <td><?php echo $tpl['arr'][$i]['coupontype']; ?></td>
                 ...
                 <?php
                    ...
                    <td style="display:none;"><a class="btn btn-success btn-sm" href="<?php echo INSTALL_URL; ?>vendordata/edit/<?php echo $tpl['arr'][$i]['id']; ?>"><span class="glyphicon glyphicon-eye-open"></span></a></td>
                    <td style="display:none;"><a cat="1" class="btn btn-danger btn-sm icon-delete" rev="<?php echo $tpl['arr'][$i]['id']; ?>" href="<?php echo INSTALL_URL; ?>pujafoodcoupon/delete/<?php echo $tpl['arr'][$i]['id']; ?>"><span class="glyphicon glyphicon-remove"></span></a></td>
                </tr>
                <?php
            }
        } else {
