...
<table id="<?php echo (count($sponsorItems)) ? "tab-sponsorhip-table-id2" : ""; ?>"
            ...
            for ($i = 0; $i < $count; $i++) {
                ...
                if ($pujaSankalpa != "") {
                    ...
                    <tr class="<?php echo $i % 2 === 0 ? 'odd' : 'even'; ?>">
                        ...
                        <td style="display:none;"><a class="btn btn-success btn-sm"
                                href="<?php echo INSTALL_URL; ?>Sponsorship/Sponsorship/<?php echo $sponsorItems[$i]['ID']; ?>"
                                rev="<?php echo $sponsorItems[$i]['ID']; ?>"><span class="glyphicon glyphicon-pencil"></span></a></td>
                        <td style="display:none;"><a cat="1" class="btn btn-danger btn-sm icon-delete"
                                rev="<?php echo $sponsorItems[$i]['ID']; ?>"
                                href="<?php echo INSTALL_URL; ?>Sponsorship/Sponsorship/<?php echo $sponsorItems[$i]['ID']; ?>"><span
...
<script>
    if ($('#tab-sponsorhip-table-id2').length > 0) {
        $('#tab-sponsorhip-table-id2').dataTable({
            "aoColumnDefs": [
