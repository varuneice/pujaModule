    ...
    $(function () {
       ...
       if ($("#dialogDelete").length > 0) {
        ...
        if ($("a.gallery-delete").length > 0) {
            $("#edit_sankalpapuja").delegate("a.gallery-delete", 'click', function (e) {
                debugger;
                e.preventDefault();
                ...
                buttons: {
                    "Delete": function () {
                        $.ajax({
                            ...
                            url: url + "index.php?controller=Pujaregistration&action=deleteEditedImage",
                            success: function (res) {
                                $("#alldocument").html(res);
                            }
                        });
                        $(this).dialog('close');
                    },
                ...
                buttons: [{
                        ...
                        click: function () {
                            ...
                            $.ajax({
                                ...
                                url: url + "index.php?controller=Pujaregistration&action=delete",
                                success: function (res) {
