        ...
        init: function (opts) {
            ...
            this.$gzCalContainer.delegate("#Puja", "change", function (e) {
                ...
                if (gz$(this).val() == 'credit_card') {
                    ...
                    gz$('#error_code1').html("Step 1 - Send your Zelle payment to treasurer@durgabari.org;"+ "<br>"+ "Step 2 - Select your payment details from  dropdown.");
                     //alert("If you want to book with zelle first you have to make payment with zelle then you will got confirm code on your email after enter confirm code you can book");
                   
                  var frm = gz$("#gz-time-slot-booking-form-id");
                   //var ur ="http://localhost:8082/000/" + "load.php?controller=GzFront&action=checkCode&cid=" + self.options.cal_id;
                   var ur ="https://durgabari.org/HDBS_Payment/" + "load.php?controller=GzFront&action=checkCode&cid=" + self.options.cal_id;
